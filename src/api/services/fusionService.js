...
const fusionChartQuery = async (gameTitle) => {
    const data = await FusionChart.find({ game: gameTitle });
    return data;
};
const elementChartQuery = async (gameTitle) => {
    const data = await ElementChart.find({ game: gameTitle });
    return data;
};
const specialFusionsQuery = async (gameTitle) => {
    const data = await SpecialFusions.find({ game: gameTitle });
    return data;
};
const fusionPrereqsQuery = async (gameTitle) => {
