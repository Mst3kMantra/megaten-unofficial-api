***REMOVED*** MongoDB Node.js Driver
...
***REMOVED******REMOVED******REMOVED*** Bugs / Feature Requests
...
***REMOVED******REMOVED******REMOVED*** Support / Feedback
...
***REMOVED******REMOVED******REMOVED*** Change Log

Change history can be found in [`HISTORY.md`](https://github.com/mongodb/node-mongodb-native/blob/HEAD/HISTORY.md).

***REMOVED******REMOVED******REMOVED*** Compatibility

For server and runtime version compatibility matrices, please refer to the following links:

- [MongoDB](https://www.mongodb.com/docs/drivers/node/current/compatibility/***REMOVED***mongodb-compatibility)
- [NodeJS](https://www.mongodb.com/docs/drivers/node/current/compatibility/***REMOVED***language-compatibility)

***REMOVED******REMOVED******REMOVED******REMOVED*** Component Support Matrix
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Typescript Version
...
***REMOVED******REMOVED*** Driver Extensions
...
- MongoDB field level and queryable encryption - [mongodb-client-encryption](https://github.com/mongodb/libmongocrypt***REMOVED***readme)
...
***REMOVED******REMOVED******REMOVED*** Create the `package.json` file
...
***REMOVED******REMOVED******REMOVED*** Start a MongoDB Server
...
***REMOVED******REMOVED******REMOVED*** Connect to MongoDB
...
> - launching mongod or mongos with the ipv6 flag enabled ([--ipv6 mongod option documentation](https://www.mongodb.com/docs/manual/reference/program/mongod/***REMOVED***std-option-mongod.--ipv6))
...
***REMOVED******REMOVED******REMOVED*** Insert a Document
...
***REMOVED******REMOVED******REMOVED*** Find All Documents
...
***REMOVED******REMOVED******REMOVED*** Find Documents with a Query Filter
...
***REMOVED******REMOVED******REMOVED*** Update a document
...
***REMOVED******REMOVED******REMOVED*** Remove a document
...
***REMOVED******REMOVED******REMOVED*** Index a Collection
...
***REMOVED******REMOVED*** Nightly releases
