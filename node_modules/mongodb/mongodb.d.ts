...
export declare interface AutoEncryptionOptions {
    ...
    kmsProviders?: {
        ...
        gcp?: {
            ...
            email: string;
            /** A PKCS***REMOVED***8 encrypted key. This can either be a base64 string or a binary representation */
...
export declare interface BSONSerializeOptions extends Omit<SerializeOptions, 'index'>, Omit<DeserializeOptions, 'evalFunctions' | 'cacheFunctions' | 'cacheFunctionsCrc32' | 'allowObjectSmallerThanBufferSize' | 'index' | 'validation'> {
     ...
     * which is allocated using [allocUnsafe API](https://nodejs.org/api/buffer.html***REMOVED***static-method-bufferallocunsafesize).
     * See this section from the [Node.js Docs here](https://nodejs.org/api/buffer.html***REMOVED***what-makes-bufferallocunsafe-and-bufferallocunsafeslow-unsafe)
...
/**
 * Creates a new Change Stream instance. Normally created using {@link Collection***REMOVED***watch|Collection.watch()}.
 * @public
 */
...
/**
 * @public
 * @see https://www.mongodb.com/docs/manual/reference/change-events/***REMOVED***delete-event
 */
...
/**
 * @public
 * @see https://www.mongodb.com/docs/manual/reference/change-events/***REMOVED***dropdatabase-event
 */
...
/**
 * @public
 * @see https://www.mongodb.com/docs/manual/reference/change-events/***REMOVED***drop-event
 */
...
/**
 * @public
 * @see https://www.mongodb.com/docs/manual/reference/change-events/***REMOVED***insert-event
 */
...
/**
 * @public
 * @see https://www.mongodb.com/docs/manual/reference/change-events/***REMOVED***invalidate-event
 */
...
export declare interface ChangeStreamOptions extends Omit<AggregateOptions, 'writeConcern'> {
     ...
     * @see https://www.mongodb.com/docs/manual/changeStreams/***REMOVED***resumeafter-for-change-streams
     */
    resumeAfter?: ResumeToken;
    /**
     * Similar to resumeAfter, but will allow you to start after an invalidated event.
     * @see https://www.mongodb.com/docs/manual/changeStreams/***REMOVED***startafter-for-change-streams
     */
...
/**
 * @public
 * @see https://www.mongodb.com/docs/manual/reference/change-events/***REMOVED***rename-event
 */
...
/**
 * @public
 * @see https://www.mongodb.com/docs/manual/reference/change-events/***REMOVED***replace-event
 */
...
/**
 * @public
 * @see https://www.mongodb.com/docs/manual/reference/change-events/***REMOVED***update-event
 */
...
export declare class ClientEncryption {
     ...
     * ```
     */
    createDataKey(***REMOVED*** ClientEncryptionDataKeyProvider, options?: ClientEncryptionCreateDataKeyProviderOptions): Promise<UUID>;
    /**
    ...
    createEncryptedCollection<TSchema extends Document = Document>(db: Db, name: string, options: {
        ***REMOVED*** ClientEncryptionDataKeyProvider;
...
/**
 * @public
 * @see https://github.com/mongodb/specifications/blob/master/source/mongodb-handshake/handshake.rst***REMOVED***hello-command
 */
...
export declare class Collection<TSchema extends Document = Document> {
     ...
     * error.
     *
     * **Note**: Unlike {@link Collection***REMOVED***createIndex| createIndex}, this function takes in raw index specifications.
     ...
     * encountering errors.
     *
     * @see {@link https://www.mongodb.com/docs/manual/reference/command/count/***REMOVED***behavior|Count: Behavior}
     * @param options - Optional settings for the command
     */
    estimatedDocumentCount(options?: EstimatedDocumentCountOptions): Promise<number>;
    /**
     * Gets the number of documents matching the filter.
     * For a fast count of the total documents in a collection see {@link Collection***REMOVED***estimatedDocumentCount| estimatedDocumentCount}.
     * **Note**: When migrating from {@link Collection***REMOVED***count| count} to {@link Collection***REMOVED***countDocuments| countDocuments}
     ...
     * [3]: https://www.mongodb.com/docs/manual/reference/operator/query/center/***REMOVED***op._S_center
     * [4]: https://www.mongodb.com/docs/manual/reference/operator/query/centerSphere/***REMOVED***op._S_centerSphere
     *
     ...
     * @see https://www.mongodb.com/docs/manual/reference/operator/query/center/***REMOVED***op._S_center
     * @see https://www.mongodb.com/docs/manual/reference/operator/query/centerSphere/***REMOVED***op._S_centerSphere
     */
     ...
     * in a collection. To obtain an accurate count of documents in the collection, use {@link Collection***REMOVED***countDocuments| countDocuments}.
     * To obtain an estimated count of all documents in the collection, use {@link Collection***REMOVED***estimatedDocumentCount| estimatedDocumentCount}.
     *
     * @deprecated use {@link Collection***REMOVED***countDocuments| countDocuments} or {@link Collection***REMOVED***estimatedDocumentCount| estimatedDocumentCount} instead
     *
     * @param filter - The filter for the count.
     * @param options - Optional settings for the command
     */
...
export declare class FindCursor<TSchema = any> extends AbstractCursor<TSchema> {
     ...
     *
     * @remarks
     * {@link https://www.mongodb.com/docs/manual/reference/command/find/***REMOVED***find-cmd-allowdiskuse | find command allowDiskUse documentation}
     */
...
export declare interface FindOneAndDeleteOptions extends CommandOperationOptions {
    /** An optional hint for query optimization. See the {@link https://www.mongodb.com/docs/manual/reference/command/update/***REMOVED***update-command-hint|update command} reference for more information.*/
    hint?: Document;
...
/**
 * A builder object that is returned from {@link BulkOperationBase***REMOVED***find}.
...
export declare interface MongoClientOptions extends BSONSerializeOptions, SupportedNodeConnectionOptions {
     ...
     *  (see [libmongocrypt: Auto Encryption Allow-List](https://github.com/mongodb/specifications/blob/master/source/client-side-encryption/client-side-encryption.rst***REMOVED***libmongocrypt-auto-encryption-allow-list)). To bypass automatic encryption for all operations, set bypassAutoEncryption=true in AutoEncryptionOpts.
     *
     *  Automatic encryption requires the authenticated user to have the [listCollections privilege action](https://www.mongodb.com/docs/manual/reference/command/listCollections/***REMOVED***dbcmd.listCollections).
     *
...
export declare interface MongoOptions extends Required<Pick<MongoClientOptions, 'autoEncryption' | 'connectTimeoutMS' | 'directConnection' | 'driverInfo' | 'forceServerObjectId' | 'minHeartbeatFrequencyMS' | 'heartbeatFrequencyMS' | 'localThresholdMS' | 'maxConnecting' | 'maxIdleTimeMS' | 'maxPoolSize' | 'minPoolSize' | 'monitorCommands' | 'noDelay' | 'pkFactory' | 'raw' | 'replicaSet' | 'retryReads' | 'retryWrites' | 'serverSelectionTimeoutMS' | 'socketTimeoutMS' | 'srvMaxHosts' | 'srvServiceName' | 'tlsAllowInvalidCertificates' | 'tlsAllowInvalidHostnames' | 'tlsInsecure' | 'waitQueueTimeoutMS' | 'zlibCompressionLevel'>>, SupportedNodeConnectionOptions {
    ...
    /**
     * ***REMOVED*** NOTE ABOUT TLS Options
     *
     ...
     *
     * ***REMOVED******REMOVED******REMOVED*** Additional options:
     *
     ...
     *
     * ***REMOVED******REMOVED******REMOVED*** Note on `tlsCAFile`, `tlsCertificateKeyFile` and `tlsCRLFile`
     *
 ...
 * @public
 * @see https://www.mongodb.com/docs/manual/reference/method/db.runCommand/***REMOVED***response
 */
...
export declare class ReadPreference {
     ...
     * @see https://www.mongodb.com/docs/manual/reference/mongodb-wire-protocol/***REMOVED***op-query
     */
    secondaryOk(): boolean;
    /**
 ...
 * @see https://www.mongodb.com/docs/manual/changeStreams/***REMOVED***std-label-change-stream-resume
 * @public
 */
...
export declare class ServerDescription {
     ...
     * in the {@link https://github.com/mongodb/specifications/blob/master/source/server-discovery-and-monitoring/server-discovery-and-monitoring.rst***REMOVED***serverdescription|SDAM spec}
     */
