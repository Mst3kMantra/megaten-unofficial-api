...
- [Usage](***REMOVED***usage)
- [Bugs/Feature Requests](***REMOVED***bugs--feature-requests)
- [Installation](***REMOVED***installation)
- [Documentation](***REMOVED***documentation)
- [FAQ](***REMOVED***faq)

***REMOVED******REMOVED*** Bugs / Feature Requests
...
***REMOVED******REMOVED******REMOVED*** Node.js or Bundling Usage
...
***REMOVED******REMOVED******REMOVED*** Browser Usage
...
***REMOVED******REMOVED******REMOVED*** MongoDB Node.js Driver Version Compatibility
...
***REMOVED******REMOVED******REMOVED*** BSON

[API documentation](https://mongodb.github.io/node-mongodb-native/Next/modules/BSON.html)

<a name="EJSON"></a>

***REMOVED******REMOVED******REMOVED*** EJSON

- [EJSON](***REMOVED***EJSON)

  - [.parse(text, [options])](***REMOVED***EJSON.parse)

  - [.stringify(value, [replacer], [space], [options])](***REMOVED***EJSON.stringify)

  - [.serialize(bson, [options])](***REMOVED***EJSON.serialize)

  - [.deserialize(ejson, [options])](***REMOVED***EJSON.deserialize)

<a name="EJSON.parse"></a>

***REMOVED******REMOVED******REMOVED******REMOVED*** _EJSON_.parse(text, [options])
...
***REMOVED******REMOVED******REMOVED******REMOVED*** _EJSON_.stringify(value, [replacer], [space], [options])
...
***REMOVED******REMOVED******REMOVED******REMOVED*** _EJSON_.serialize(bson, [options])
...
***REMOVED******REMOVED******REMOVED******REMOVED*** _EJSON_.deserialize(ejson, [options])
...
***REMOVED******REMOVED******REMOVED*** Technical Note about React Native module import
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Why does `undefined` get converted to `null`?

The `undefined` BSON type has been [deprecated for many years](http://bsonspec.org/spec.html), so this library has dropped support for it. Use the `ignoreUndefined` option (for example, from the [driver](http://mongodb.github.io/node-mongodb-native/2.2/api/MongoClient.html***REMOVED***connect) ) to instead remove `undefined` keys.

***REMOVED******REMOVED******REMOVED******REMOVED*** How do I add custom serialization logic?
