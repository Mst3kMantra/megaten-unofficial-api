 ...
 * @internal
 */
export function getTopology(***REMOVED*** TopologyProvider): Topology {
...
// @see https://github.com/mongodb/specifications/blob/master/source/read-write-concern/read-write-concern.rst***REMOVED***read-concern
