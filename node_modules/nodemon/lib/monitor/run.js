...
function run(options) {
  ...
  if (utils.isWindows) {
    ...
    // ref ***REMOVED***1251 and ***REMOVED***1236
...
function kill(child, signal, callback) {
  ...
  if (utils.isWindows) {
    ...
    try {
      ...
      // standard POSIX signal 'SIGINT' to the node process. This fixes ***REMOVED***1720.
      ...
      // See: https://github.com/alirdn/windows-kill***REMOVED***how-it-works--limitations
      //
    ...
    // configured signal (default: SIGUSR2) signal, which fixes ***REMOVED***335
