...
[![Backers on Open Collective](https://opencollective.com/nodemon/backers/badge.svg)](***REMOVED***backers) [![Sponsors on Open Collective](https://opencollective.com/nodemon/sponsors/badge.svg)](***REMOVED***sponsors)
...
```bash
npm install -g nodemon ***REMOVED*** or using yarn: yarn global add nodemon
```
...
```bash
npm install --save-dev nodemon ***REMOVED*** or using yarn: yarn add nodemon -D
```
...
***REMOVED******REMOVED*** Automatic re-running

nodemon was originally written to restart hanging processes such as web servers, but now supports apps that cleanly exit. If your script exits cleanly, nodemon will continue to monitor the directory (or directories) and restart the script if there are any changes.

***REMOVED******REMOVED*** Manual restarting
...
***REMOVED******REMOVED******REMOVED*** package.json
...
***REMOVED******REMOVED*** Using nodemon as a module

Please see [doc/requireable.md](doc/requireable.md)

***REMOVED******REMOVED*** Using nodemon as child process

Please see [doc/events.md](doc/events.md***REMOVED***Using_nodemon_as_child_process)

***REMOVED******REMOVED*** Running non-node scripts
...
***REMOVED******REMOVED******REMOVED*** Default executables
...
***REMOVED******REMOVED*** Monitoring multiple directories
...
***REMOVED******REMOVED*** Specifying extension watch list
...
***REMOVED******REMOVED*** Ignoring files
...
Note that by default, nodemon will ignore the `.git`, `node_modules`, `bower_components`, `.nyc_output`, `coverage` and `.sass-cache` directories and *add* your ignored patterns to the list. If you want to indeed watch a directory like `node_modules`, you need to [override the underlying default ignore rules](https://github.com/remy/nodemon/blob/master/faq.md***REMOVED***overriding-the-underlying-default-ignore-rules).

***REMOVED******REMOVED*** Application isn't restarting
...
***REMOVED******REMOVED*** Delaying restarting
...
***REMOVED******REMOVED*** Gracefully reloading down your script
...
***REMOVED******REMOVED*** Controlling shutdown of your script
...
***REMOVED******REMOVED*** Triggering events when nodemon state changes
...
A full list of available events is listed on the [event states wiki](https://github.com/remy/nodemon/wiki/Events***REMOVED***states). Note that you can bind to both states and messages.

***REMOVED******REMOVED*** Pipe output to somewhere else
...
***REMOVED******REMOVED*** Using nodemon in your gulp workflow
...
***REMOVED******REMOVED*** Using nodemon in your Grunt workflow

Check out the [grunt-nodemon](https://github.com/ChrisWren/grunt-nodemon) plugin to integrate nodemon with the rest of your project's grunt workflow.

***REMOVED******REMOVED*** Pronunciation
...
***REMOVED******REMOVED*** Backers

Thank you to all [our backers](https://opencollective.com/nodemon***REMOVED***backer)! 🙏

[![nodemon backers](https://opencollective.com/nodemon/backers.svg?width=890)](https://opencollective.com/nodemon***REMOVED***backers)

***REMOVED******REMOVED*** Sponsors

Support this project by becoming a sponsor. Your logo will show up here with a link to your website. [Sponsor this project today ❤️](https://opencollective.com/nodemon***REMOVED***sponsor)
