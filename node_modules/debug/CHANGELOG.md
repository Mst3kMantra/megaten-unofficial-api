...
==================
  ...
  * Fix: null reference check on window.documentElement.style.WebkitAppearance (***REMOVED***447, @thebigredgeek)
...
==================
  ...
  * Fix: bug that would occure if process.env.DEBUG is a non-string value. (***REMOVED***444, @LucianBuzzo)
...
==================
  ...
  * package: add "license" field to package.json (***REMOVED***135, @panuhorsmalahti)

2.0.0 / 2014-09-01
==================

  * package: update "browserify" to v5.11.0
  * node: use stderr rather than stdout for logging (***REMOVED***29, @stephenmathieson)
...
==================
  ...
  * debug: prefer an instance `log()` function over the global one (***REMOVED***119)
  * Readme: update documentation about styled console logs for FF v31 (***REMOVED***116, @wryk)

1.0.3 / 2014-07-09
==================

  * Add support for multiple wildcards in namespaces (***REMOVED***122, @seegno)
  * browser: fix lint

1.0.2 / 2014-06-10
==================

  * browser: update color palette (***REMOVED***113, @gscottolson)
  * common: make console logging function configurable (***REMOVED***108, @timoxley)
  * node: fix %o colors on old node <= 0.8.x
  * Makefile: find node path using shell/which (***REMOVED***109, @timoxley)

1.0.1 / 2014-06-06
==================

  * browser: use `removeItem()` to clear localStorage
  * browser, node: don't set DEBUG if namespaces is undefined (***REMOVED***107, @leedm777)
