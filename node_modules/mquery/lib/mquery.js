 ...
 * - [sort](http://www.mongodb.org/display/DOCS/Advanced+Queries***REMOVED***AdvancedQueries-%7B%7Bsort(\)%7D%7D) *
 * - [limit](http://www.mongodb.org/display/DOCS/Advanced+Queries***REMOVED***AdvancedQueries-%7B%7Blimit%28%29%7D%7D) *
 * - [skip](http://www.mongodb.org/display/DOCS/Advanced+Queries***REMOVED***AdvancedQueries-%7B%7Bskip%28%29%7D%7D) *
 * - [maxTime](http://docs.mongodb.org/manual/reference/operator/meta/maxTimeMS/***REMOVED***op._S_maxTimeMS) *
 * - [batchSize](http://www.mongodb.org/display/DOCS/Advanced+Queries***REMOVED***AdvancedQueries-%7B%7BbatchSize%28%29%7D%7D) *
 * - [comment](http://www.mongodb.org/display/DOCS/Advanced+Queries***REMOVED***AdvancedQueries-%24comment) *
 * - [hint](http://www.mongodb.org/display/DOCS/Advanced+Queries***REMOVED***AdvancedQueries-%24hint) *
 * - [slaveOk](http://docs.mongodb.org/manual/applications/replication/***REMOVED***read-preference) *
 ...
 * @param {Object} value
 * @return {Query} this
 * @see MongoDB docs https://docs.mongodb.com/manual/reference/method/cursor.collation/***REMOVED***cursor.collation
 * @api public
 */
 ...
 * @see Query***REMOVED***within ***REMOVED***query_Query-within
 * @param {String} path
 * @param {Object} val
 * @return {Query} this
 * @api public
 ...
 * @return {Query} this
 * @see http://docs.mongodb.org/manual/release-notes/2.4/***REMOVED***new-geospatial-indexes-with-geojson-and-improved-spherical-geometry
 * @see http://www.mongodb.org/display/DOCS/Geospatial+Indexing
 ...
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** String syntax
 *
 ...
 * @return {Query} this
 * @see mongodb http://www.mongodb.org/display/DOCS/Retrieving+a+Subset+of+Fields***REMOVED***RetrievingaSubsetofFields-RetrievingaSubrangeofArrayElements
 * @api public
 */
 ...
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Note:
 *
 *  - The array syntax `.sort([['field', 1], ['test', -1]])` can only be used with [mongodb driver >= 2.0.46](https://github.com/mongodb/node-mongodb-native/blob/2.1/HISTORY.md***REMOVED***2046-2015-10-15).
 *  - Cannot be used with `distinct()`
 *
 ...
 * @memberOf Query
 * @param {Number} val
 * @see mongodb http://www.mongodb.org/display/DOCS/Advanced+Queries***REMOVED***AdvancedQueries-%7B%7Blimit%28%29%7D%7D
 * @api public
 */
/**
 ...
 * @memberOf Query
 * @param {Number} val
 * @see mongodb http://www.mongodb.org/display/DOCS/Advanced+Queries***REMOVED***AdvancedQueries-%7B%7Bskip%28%29%7D%7D
 * @api public
 */
/**
 ...
 * @memberOf Query
 * @param {Number} val
 * @see mongodb http://www.mongodb.org/display/DOCS/Advanced+Queries***REMOVED***AdvancedQueries-%7B%7BbatchSize%28%29%7D%7D
 * @api public
 */
/**
 ...
 * @memberOf Query
 * @param {Number} val
 * @see mongodb http://www.mongodb.org/display/DOCS/Advanced+Queries***REMOVED***AdvancedQueries-%24comment
 * @api public
 */
 ...
 * @memberOf Query
 * @param {Number} ms
 * @see mongodb http://docs.mongodb.org/manual/reference/operator/meta/maxTimeMS/***REMOVED***op._S_maxTimeMS
 * @api public
 */
 ...
 * @return {Query} this
 * @see mongodb http://www.mongodb.org/display/DOCS/Advanced+Queries***REMOVED***AdvancedQueries-%24hint
 * @api public
 */
 ...
 * @instance
 * @param {boolean} val
 * @see mongodb https://docs.mongodb.com/manual/reference/write-concern/***REMOVED***j-option
 * @return {Query} this
 * @api public
 */
 ...
 * @see mongodb http://docs.mongodb.org/manual/applications/replication/***REMOVED***read-preference
 * @see read()
 * @return {Query} this
 * @api public
 */
 ...
 *     n   nearest
 *
 * Read more about how to use read preferences [here](http://docs.mongodb.org/manual/applications/replication/***REMOVED***read-preference) and [here](http://mongodb.github.com/node-mongodb-native/driver-articles/anintroductionto1_1and2_2.html***REMOVED***read-preferences).
 *
 * @param {String|ReadPreference} pref one of the listed preference options or their aliases
 * @see mongodb http://docs.mongodb.org/manual/applications/replication/***REMOVED***read-preference
 * @see driver http://mongodb.github.com/node-mongodb-native/driver-articles/anintroductionto1_1and2_2.html***REMOVED***read-preferences
 * @return {Query} this
 * @api public
 */
 ...
 * @memberOf Query
 * @instance
 * @param {String|number|object} concern 0 for fire-and-forget, 1 for acknowledged by one server, 'majority' for majority of the replica set, or [any of the more advanced options](https://docs.mongodb.com/manual/reference/write-concern/***REMOVED***w-option).
 * @see mongodb https://docs.mongodb.com/manual/reference/write-concern/***REMOVED***w-option
 * @return {Query} this
 * @api public
 */
 ...
 * @see mongodb https://docs.mongodb.com/manual/reference/write-concern/***REMOVED***wtimeout
 * @return {Query} this
 * @api public
 */
 ...
 * @param {Object} [criteria] mongodb selector
 * @return {Query} this
 * @see mongodb http://www.mongodb.org/display/DOCS/Aggregation***REMOVED***Aggregation-Count
 * @api public
 */
 ...
 * @param {String} [field]
 * @return {Query} this
 * @see mongodb http://www.mongodb.org/display/DOCS/Aggregation***REMOVED***Aggregation-Distinct
 * @api public
 */
