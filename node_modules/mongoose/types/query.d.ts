declare module 'mongoose' {
  ...
  type RootQuerySelector<T> = {
    /** @see https://www.mongodb.com/docs/manual/reference/operator/query/and/***REMOVED***op._S_and */
    $and?: Array<FilterQuery<T>>;
    /** @see https://www.mongodb.com/docs/manual/reference/operator/query/nor/***REMOVED***op._S_nor */
    $nor?: Array<FilterQuery<T>>;
    /** @see https://www.mongodb.com/docs/manual/reference/operator/query/or/***REMOVED***op._S_or */
    ...
    /** @see https://www.mongodb.com/docs/manual/reference/operator/query/where/***REMOVED***op._S_where */
    $where?: string | Function;
    /** @see https://www.mongodb.com/docs/manual/reference/operator/query/comment/***REMOVED***op._S_comment */
    $comment?: string;
  ...
  interface QueryOptions<DocType = unknown> extends
     ...
     * (https://mongoosejs.com/docs/validation.html***REMOVED***update-validators). Defaults to false.
     */
     ...
     * [strictQuery](https://mongoosejs.com/docs/guide.html***REMOVED***strictQuery) mode for schemas.
     */
  ...
  class Query<ResultType, DocType, THelpers = {}, RawDocType = DocType, QueryOp = 'find'> implements SessionOperation {
     ...
     * not accept any [atomic](https://www.mongodb.com/docs/manual/tutorial/model-data-for-atomic-operations/***REMOVED***pattern) operators (`$set`, etc.)
     */
    replaceOne(
      filter?: FilterQuery<DocType>,
    ...
    /**
     * If [`w > 1`](/docs/api/query.html***REMOVED***query_Query-w), the maximum amount of time to
