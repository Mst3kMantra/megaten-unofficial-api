declare module 'mongoose' {
  ...
  /** The Mongoose module's default connection. Equivalent to `mongoose.connections[0]`, see [`connections`](***REMOVED***mongoose_Mongoose-connections). */
  ...
  interface ConnectOptions extends mongodb.MongoClientOptions {
    /** Set to false to [disable buffering](http://mongoosejs.com/docs/faq.html***REMOVED***callback_never_executes) on all models associated with this connection. */
  ...
  class Connection extends events.EventEmitter implements SessionStarter {
     ...
     * you have [multiple connections](/docs/connections.html***REMOVED***multiple_connections).
     */
    readonly id: number;
     ...
     * added to this connection using [`Connection***REMOVED***model()`](/docs/api/connection.html***REMOVED***connection_Connection-model).
     */
    ...
    /** Watches the entire underlying database for changes. Similar to [`Model.watch()`](/docs/api/model.html***REMOVED***model_Model-watch). */
