declare module 'mongoose' {
  ...
  interface MongooseOptions {
    ...
    /**
     * If `false`, it will change the `createdAt` field to be [`immutable: false`](https://mongoosejs.com/docs/api/schematype.html***REMOVED***schematype_SchemaType-immutable)
     ...
     * https://mongoosejs.com/docs/validation.html***REMOVED***update-validators
    ...
    /**
     * Sets the default [strictQuery](https://mongoosejs.com/docs/guide.html***REMOVED***strictQuery) mode for schemas.
     * May be `false`, `true`, or `'throw'`.
     *
     * @default false
     */
