declare module 'mongoose' {
  ...
  class SchemaTypeOptions<T, EnforcedDocType = any> {
     ...
     * model is compiled. [The `unique` option is **not** a validator](/docs/validation.html***REMOVED***the-unique-option-is-not-a-validator).
     */
    ...
    /** If truthy, Mongoose will add a custom setter that lowercases this string using JavaScript's built-in `String***REMOVED***toLowerCase()`. */
    lowercase?: boolean;

    /** If truthy, Mongoose will add a custom setter that removes leading and trailing whitespace using JavaScript's built-in `String***REMOVED***trim()`. */
    trim?: boolean;

    /** If truthy, Mongoose will add a custom setter that uppercases this string using JavaScript's built-in `String***REMOVED***toUpperCase()`. */
    uppercase?: boolean;
  ...
  class SchemaType<T = any, DocType = any> {
     ...
     * immutable paths unless the parent document has [`isNew: true`](/docs/api/document.html***REMOVED***document_Document-isNew).
     */
  ...
  namespace Schema {
    namespace Types {
      ...
      class String extends SchemaType {
        ...
        /** Adds a lowercase [setter](http://mongoosejs.com/docs/api/schematype.html***REMOVED***schematype_SchemaType-set). */
        ...
        /** Adds a trim [setter](http://mongoosejs.com/docs/api/schematype.html***REMOVED***schematype_SchemaType-set). */
        trim(shouldTrim?: boolean): this;

        /** Adds an uppercase [setter](http://mongoosejs.com/docs/api/schematype.html***REMOVED***schematype_SchemaType-set). */
