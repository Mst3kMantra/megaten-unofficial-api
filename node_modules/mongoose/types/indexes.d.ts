declare module 'mongoose' {
  ...
  interface IndexManager {
    /**
     * Similar to `ensureIndexes()`, except for it uses the [`createIndex`](https://mongodb.github.io/node-mongodb-native/4.9/classes/Collection.html***REMOVED***createIndex)
     * function.
     */
     ...
     * use the [`autoIndex` option](/docs/guide.html***REMOVED***autoIndex) and if you
