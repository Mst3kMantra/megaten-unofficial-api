declare module 'mongoose' {
  ...
  class Document<T = any, TQueryHelpers = any, DocType = any> {
     ...
     * [minimize option](/docs/guide.html***REMOVED***minimize).
     */
    ...
    */
    ...
    /** Saves this document by inserting a new document into the database if [document.isNew](/docs/api/document.html***REMOVED***document_Document-isNew) is `true`, or sends an [updateOne](/docs/api/document.html***REMOVED***document_Document-updateOne) operation with just the modified paths if `isNew` is `false`. */
