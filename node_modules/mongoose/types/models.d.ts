declare module 'mongoose' {
  ...
  interface ModifyResult<T> {
    ...
    /** see https://www.mongodb.com/docs/manual/reference/command/findAndModify/***REMOVED***lasterrorobject */
    lastErrorObject?: {
...
***REMOVED*** NodeJS.EventEmitter;
     ...
     * unless [`autoIndex`](http://mongoosejs.com/docs/guide.html***REMOVED***autoIndex) is turned off.
     * Mongoose calls this function automatically when a model is created using
     * [`mongoose.model()`](/docs/api/mongoose.html***REMOVED***mongoose_Mongoose-model) or
     * [`connection.model()`](/docs/api/connection.html***REMOVED***connection_Connection-model), so you
