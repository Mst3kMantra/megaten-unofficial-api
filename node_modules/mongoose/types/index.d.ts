...
declare module 'mongoose' {
  ...
  >
     ...
     * to schema [virtuals](http://mongoosejs.com/docs/guide.html***REMOVED***virtuals),
     * [statics](http://mongoosejs.com/docs/guide.html***REMOVED***statics), and
     * [methods](http://mongoosejs.com/docs/guide.html***REMOVED***methods).
     */
  ...
  export interface VirtualTypeOptions<HydratedDocType = Document, DocType = unknown> {
     ...
     * documents, as opposed to the documents themselves, using `Query***REMOVED***countDocuments()`.
     */
    count?: boolean;
   ...
   * https://www.typescriptlang.org/docs/handbook/2/conditional-types.html***REMOVED***distributive-conditional-types
   */
