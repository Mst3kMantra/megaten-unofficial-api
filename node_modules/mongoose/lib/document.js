 ...
 * the Mongoose [Model constructor](./api/model.html***REMOVED***Model) calls this for you.
 *
 * @param {Object} obj the values to set
 * @param {Object} [fields] optional object containing the fields which were selected in the query returning this document and any populated paths data
 * @param {Object} [options] various configuration options for the document
 * @param {Boolean} [options.defaults=true] if `false`, skip applying default values to this document.
 * @inherits NodeJS EventEmitter https://nodejs.org/api/events.html***REMOVED***class-eventemitter
 ...
 * @property isNew
 * @memberOf Document
 * @see $isNew https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.$isNew
 * @instance
 */
 ...
 *
 * This getter exists on all documents by default. The getter can be disabled by setting the `id` [option](https://mongoosejs.com/docs/guide.html***REMOVED***id) of its `Schema` to false at construction time.
 *
 *     new Schema({ name: String }, { id: false });
 *
 * @api public
 * @see Schema options https://mongoosejs.com/docs/guide.html***REMOVED***options
 * @property id
 * @memberOf Document
 * @instance
 */
 ...
 * Note that `init` hooks are [synchronous](https://mongoosejs.com/docs/middleware.html***REMOVED***synchronous).
 *
...
/**
 * Alias for [`.init`](https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.init())
 *
 * @api public
 */
 ...
 *
 *  - same as in [Model.updateOne](https://mongoosejs.com/docs/api/model.html***REMOVED***Model.updateOne)
 *
 * @see Model.updateOne https://mongoosejs.com/docs/api/model.html***REMOVED***Model.updateOne
 * @param {Object} doc
 ...
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Valid options:
 *
 *  - same as in [Model.replaceOne](https://mongoosejs.com/docs/api/model.html***REMOVED***Model.replaceOne())
 *
 ...
 * @param {Boolean} [options.merge=false] if true, setting a [nested path](https://mongoosejs.com/docs/subdocs.html***REMOVED***subdocuments-versus-nested-paths) will merge existing values rather than overwrite the whole object. So `doc.set('nested', { a: 1, b: 2 })` becomes `doc.set('nested.a', 1); doc.set('nested.b', 2);`
 * @return {Document} this
 * @method $set
 * @memberOf Document
 * @instance
...
Document.prototype.$set = function $set(path, val, type, options) {
  ...
  try {
    ...
    if (!didPopulate && this.$__.populated) {
      ...
      // all to ObjectIds re: ***REMOVED***8443
 ...
 * Alias for [`.$set`](https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.$set()).
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
 *     // path, value
 ...
 *
 * _Very helpful when using [Mixed](https://mongoosejs.com/docs/schematypes.html***REMOVED***mixed) types._
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
 ...
 * [minimize option](https://mongoosejs.com/docs/guide.html***REMOVED***minimize).
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
...
/**
 * Alias of [`.isModified`](https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.isModified())
 *
 * @method $isModified
 * @memberOf Document
 * @api public
...
/**
 * Checks if `path` is in the `init` state, that is, it was set by `Document***REMOVED***init()` and not modified since.
 *
 * @param {String} [path]
 * @return {Boolean}
 * @api public
 ...
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Note:
 *
 * This method is called `pre` save and if a validation rule is violated, [save](https://mongoosejs.com/docs/api/model.html***REMOVED***Model.prototype.save()) is aborted and the error is thrown.
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
...
/**
 * Alias of [`.validate`](https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.validate())
 *
 * @method $validate
 * @memberOf Document
 * @api public
...
function _getPathsToValidate(doc, pathsToValidate, pathsToSkip) {
  ...
  for (const path of paths) {
    ...
    if (!_pathType.$isMongooseArray ||
        ...
        // it unless we have a case of ***REMOVED***6364
 ...
 * or sends an [updateOne](https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.updateOne()) operation **only** with the modifications to the database, it does not replace the whole document in the latter case.
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
 ...
 * @param {Boolean} [options.checkKeys=true] the MongoDB driver prevents you from saving keys that start with '$' or contain '.' by default. Set this option to `false` to skip that check. See [restrictions on field names](https://www.mongodb.com/docs/manual/reference/limits/***REMOVED***Restrictions-on-Field-Names)
 ...
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Getters/Virtuals
 *
 ...
 *
 * To apply these options to every document of your schema by default, set your [schemas](https://mongoosejs.com/docs/api/schema.html***REMOVED***Schema()) `toObject` option to the same argument.
 *
 ...
 *
 * See [schema options](https://mongoosejs.com/docs/guide.html***REMOVED***toObject) for some more details.
 *
...
/**
 * The return value of this method is used in calls to [`JSON.stringify(doc)`](https://thecodebarbarian.com/the-80-20-guide-to-json-stringify-in-javascript***REMOVED***the-tojson-function).
 *
 * This method accepts the same options as [Document***REMOVED***toObject](https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.toObject()). To apply the options to every document of your schema by default, set your [schemas](https://mongoosejs.com/docs/api/schema.html***REMOVED***Schema()) `toJSON` option to the same argument.
 *
 *     schema.set('toJSON', { virtuals: true });
 *
 * There is one difference between `toJSON()` and `toObject()` options.
 * When you call `toJSON()`, the [`flattenMaps` option](https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.toObject()) defaults to `true`, because `JSON.stringify()` doesn't convert maps to objects by default.
 * When you call `toObject()`, the `flattenMaps` option is `false` by default.
 *
 * See [schema options](https://mongoosejs.com/docs/guide.html***REMOVED***toJSON) for more information on setting `toJSON` option defaults.
 *
 * @param {Object} options
 * @param {Boolean} [options.flattenMaps=true] if true, convert Maps to [POJOs](https://masteringjs.io/tutorials/fundamentals/pojo). Useful if you want to `JSON.stringify()` the result.
 * @param {Boolean} [options.flattenObjectIds=false] if true, convert any ObjectIds in the result to 24 character hex strings.
 * @return {Object}
 * @see Document***REMOVED***toObject https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.toObject()
...
/**
 * Alias for [`parent()`](https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.parent()). If this document is a subdocument or populated
...
/**
 * Alias of [`.populated`](https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.populated()).
 *
 * @method $populated
 * @memberOf Document
 * @api public
 ...
 * @return {Document} this
 * @see Document.populate https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.populate()
 * @api public
 * @memberOf Document
 * @instance
 */
