...
const methods = {
  ...
  /**
   * Overrides MongooseArray***REMOVED***cast
   *
   * @method _cast
   * @api private
  ...
  _cast(value, index, options) {
    ...
    if (isInstance ||
        // Hack re: ***REMOVED***5001, see ***REMOVED***5005
   ...
   *
   * _Each sub-document is converted to a plain object by calling its `***REMOVED***toObject` method._
   *
