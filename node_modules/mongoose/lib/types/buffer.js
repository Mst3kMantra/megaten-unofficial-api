...
const pathSymbol = Symbol.for('mongoose***REMOVED***Buffer***REMOVED***_path');
const parentSymbol = Symbol.for('mongoose***REMOVED***Buffer***REMOVED***_parent');
...
MongooseBuffer.mixin = {
   ...
   *
   * `Buffer***REMOVED***copy` does not mark `target` as modified so you must copy from a `MongooseBuffer` for it to work as expected. This is a work around since `copy` modifies the target, not this.
   *
 ...
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** SubTypes:
 *
 ...
 *
 * @see bsonspec https://bsonspec.org/***REMOVED***/specification
 * @param {Hex} [subtype]
 * @return {Binary}
 * @api public
 * @method toObject
