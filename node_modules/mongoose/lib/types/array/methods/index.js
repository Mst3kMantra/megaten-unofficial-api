...
const slicedSymbol = Symbol('mongoose***REMOVED***Array***REMOVED***sliced');
...
const methods = {
  ...
  /**
   * Wraps [`Array***REMOVED***pop`](https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Array/pop) with proper change tracking.
   *
   * ***REMOVED******REMOVED******REMOVED******REMOVED*** Note:
   *
   ...
   *
   * @see MongooseArray***REMOVED***$pop https://mongoosejs.com/docs/api/array.html***REMOVED***MongooseArray.prototype.$pop()
   * @api public
   * @method pop
   * @memberOf MongooseArray
   */
   ...
   * [the `Document.equals()` function.](https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.equals())
   *
   * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
   *
  ...
  pull() {
    ...
    // to a `$set` on the whole array. See ***REMOVED***3511
  ...
  /**
   * Wraps [`Array***REMOVED***push`](https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Array/push) with proper change tracking.
   *
   * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
   *
  ...
  push() {
    ...
    if (isOverwrite) {
      ...
      if ((atomics.$push && atomics.$push.$each && atomics.$push.$each.length || 0) !== 0 &&
        ...
        throw new MongooseError('Cannot call `Array***REMOVED***push()` multiple times ' +
  ...
  /**
   * Alias of [pull](https://mongoosejs.com/docs/api/array.html***REMOVED***MongooseArray.prototype.pull())
   *
   * @see MongooseArray***REMOVED***pull https://mongoosejs.com/docs/api/array.html***REMOVED***MongooseArray.prototype.pull()
   * @see mongodb https://www.mongodb.com/docs/manual/reference/operator/update/pull/
   * @api public
   * @memberOf MongooseArray
   * @instance
   ...
   *
   *     // VS not using array***REMOVED***set
   *     doc.array[1] = "5";
  ...
  /**
   * Wraps [`Array***REMOVED***shift`](https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Array/unshift) with proper change tracking.
   *
   * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
   *
   *     doc.array = [2,3];
  ...
  /**
   * Wraps [`Array***REMOVED***sort`](https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Array/sort) with proper change tracking.
   *
   * ***REMOVED******REMOVED******REMOVED******REMOVED*** Note:
   *
   * _marks the entire array as modified, which if saved, will store it as a `$set` operation, potentially overwritting any changes that happen between when you retrieved the object and when you save it._
  ...
  /**
   * Wraps [`Array***REMOVED***splice`](https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Array/splice) with proper change tracking and casting.
   *
   * ***REMOVED******REMOVED******REMOVED******REMOVED*** Note:
   *
   * _marks the entire array as modified, which if saved, will store it as a `$set` operation, potentially overwritting any changes that happen between when you retrieved the object and when you save it._
  ...
  /**
   * Wraps [`Array***REMOVED***unshift`](https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Array/unshift) with proper change tracking.
   *
   * ***REMOVED******REMOVED******REMOVED******REMOVED*** Note:
   *
