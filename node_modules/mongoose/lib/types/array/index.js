 ...
 *
 * _Values always have to be passed to the constructor to initialize, otherwise `MongooseArray***REMOVED***push` will mark the array as modified._
 *
 * @param {Array} values
 * @param {String} path
...
function MongooseArray(values, path, doc, schematype) {
  ...
  // can happen if there was a null somewhere up the chain (see ***REMOVED***3020)
