 ...
 * @param {String|Function} [options.ref] if `ref` is not nullish, this becomes a [populated virtual](https://mongoosejs.com/docs/populate.html***REMOVED***populate-virtuals)
 ...
 * @param {Boolean} [options.count=false] if you set this to `true`, `populate()` will set this virtual to the number of populated documents, as opposed to the documents themselves, using [`Query***REMOVED***countDocuments()`](https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.countDocuments())
