...
NativeConnection.prototype.doClose = async function doClose(force) {
  ...
  // the pool, see https://github.com/mongodb-js/mongodb-core/blob/a8f8e4ce41936babc3b9112bf42d609779f03b39/lib/connection/pool.js***REMOVED***L1026-L1030.
  ...
  if (this.readyState === STATES.connecting || this.readyState === STATES.connected) {
    if (this._connectionString !== uri) {
      throw new MongooseError('Can\'t call `openUri()` on an active connection with ' +
        ...
        'multiple times. See: https://mongoosejs.com/docs/connections.html***REMOVED***multiple_connections');
    }
  }
