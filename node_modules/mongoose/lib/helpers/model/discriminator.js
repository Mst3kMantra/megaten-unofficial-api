...
module.exports = function discriminator(model, name, schema, tiedValue, applyPlugins, mergeHooks) {
  ...
  function merge(schema, baseSchema) {
    ...
    // Rebuild schema models because schemas may have been merged re: ***REMOVED***7884
    ...
    delete schema._requiredpaths; // reset just in case Schema***REMOVED***requiredPaths() was called on either schema
  }
