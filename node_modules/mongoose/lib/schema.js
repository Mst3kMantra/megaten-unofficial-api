 ...
 *
 * - [autoIndex](https://mongoosejs.com/docs/guide.html***REMOVED***autoIndex): bool - defaults to null (which means use the connection's autoIndex option)
 * - [autoCreate](https://mongoosejs.com/docs/guide.html***REMOVED***autoCreate): bool - defaults to null (which means use the connection's autoCreate option)
 * - [bufferCommands](https://mongoosejs.com/docs/guide.html***REMOVED***bufferCommands): bool - defaults to true
 * - [bufferTimeoutMS](https://mongoosejs.com/docs/guide.html***REMOVED***bufferTimeoutMS): number - defaults to 10000 (10 seconds). If `bufferCommands` is enabled, the amount of time Mongoose will wait for connectivity to be restablished before erroring out.
 * - [capped](https://mongoosejs.com/docs/guide.html***REMOVED***capped): bool | number | object - defaults to false
 * - [collection](https://mongoosejs.com/docs/guide.html***REMOVED***collection): string - no default
 * - [discriminatorKey](https://mongoosejs.com/docs/guide.html***REMOVED***discriminatorKey): string - defaults to `__t`
 * - [id](https://mongoosejs.com/docs/guide.html***REMOVED***id): bool - defaults to true
 * - [_id](https://mongoosejs.com/docs/guide.html***REMOVED***_id): bool - defaults to true
 * - [minimize](https://mongoosejs.com/docs/guide.html***REMOVED***minimize): bool - controls [document***REMOVED***toObject](https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.toObject()) behavior when called manually - defaults to true
 * - [read](https://mongoosejs.com/docs/guide.html***REMOVED***read): string
 * - [writeConcern](https://mongoosejs.com/docs/guide.html***REMOVED***writeConcern): object - defaults to null, use to override [the MongoDB server's default write concern settings](https://www.mongodb.com/docs/manual/reference/write-concern/)
 * - [shardKey](https://mongoosejs.com/docs/guide.html***REMOVED***shardKey): object - defaults to `null`
 * - [strict](https://mongoosejs.com/docs/guide.html***REMOVED***strict): bool - defaults to true
 * - [strictQuery](https://mongoosejs.com/docs/guide.html***REMOVED***strictQuery): bool - defaults to false
 * - [toJSON](https://mongoosejs.com/docs/guide.html***REMOVED***toJSON) - object - no default
 * - [toObject](https://mongoosejs.com/docs/guide.html***REMOVED***toObject) - object - no default
 * - [typeKey](https://mongoosejs.com/docs/guide.html***REMOVED***typeKey) - string - defaults to 'type'
 * - [validateBeforeSave](https://mongoosejs.com/docs/guide.html***REMOVED***validateBeforeSave) - bool - defaults to `true`
 * - [validateModifiedOnly](https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.validate()) - bool - defaults to `false`
 * - [versionKey](https://mongoosejs.com/docs/guide.html***REMOVED***versionKey): string or object - defaults to "__v"
 * - [optimisticConcurrency](https://mongoosejs.com/docs/guide.html***REMOVED***optimisticConcurrency): bool - defaults to false. Set to true to enable [optimistic concurrency](https://thecodebarbarian.com/whats-new-in-mongoose-5-10-optimistic-concurrency.html).
 * - [collation](https://mongoosejs.com/docs/guide.html***REMOVED***collation): object - defaults to null (which means use no collation)
 * - [timeseries](https://mongoosejs.com/docs/guide.html***REMOVED***timeseries): object - defaults to null (which means this schema's collection won't be a timeseries collection)
 * - [selectPopulatedPaths](https://mongoosejs.com/docs/guide.html***REMOVED***selectPopulatedPaths): boolean - defaults to `true`
 * - [skipVersioning](https://mongoosejs.com/docs/guide.html***REMOVED***skipVersioning): object - paths to exclude from versioning
 * - [timestamps](https://mongoosejs.com/docs/guide.html***REMOVED***timestamps): object or boolean - defaults to `false`. If true, Mongoose adds `createdAt` and `updatedAt` properties to your schema and manages those properties for you.
 * - [pluginTags](https://mongoosejs.com/docs/guide.html***REMOVED***pluginTags): array of strings - defaults to `undefined`. If set and plugin called with `tags` option, will only apply that plugin to schemas with a matching tag.
 * - [virtuals](https://mongoosejs.com/docs/tutorials/virtuals.html***REMOVED***virtuals-via-schema-options): object - virtuals to define, alias for [`.virtual`](https://mongoosejs.com/docs/api/schema.html***REMOVED***Schema.prototype.virtual())
 ...
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Options for Nested Schemas:
 *
 ...
 *
 * This method is analagous to [Lodash's `pick()` function](https://lodash.com/docs/4.17.15***REMOVED***pick) for Mongoose schemas.
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
...
Schema.prototype.pick = function(paths, options) {
  ...
  if (!Array.isArray(paths)) {
    throw new MongooseError('Schema***REMOVED***pick() only accepts an array argument, ' +
      'got "' + typeof paths + '"');
  }
 ...
 *
 * This method is analagous to [Lodash's `omit()` function](https://lodash.com/docs/***REMOVED***omit) for Mongoose schemas.
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
 *     const schema = Schema({ name: String, age: Number });
...
Schema.prototype.omit = function(paths, options) {
  ...
  if (!Array.isArray(paths)) {
    throw new MongooseError(
      'Schema***REMOVED***omit() only accepts an array argument, ' +
        'got "' +
        typeof paths +
        '"'
    );
 ...
 *
 *     const doc = await Event.create({ kind: 'clicked', element: '***REMOVED***hero' });
 *     doc.element; // '***REMOVED***hero'
...
Schema.prototype.add = function add(obj, prefix) {
  ...
  for (const key of keys) {
    ...
    if (!(isPOJO(val) || val instanceof SchemaTypeOptions)) {
      ...
      // nested object `{ last: { name: String } }`. Avoid functions with `.type` re: ***REMOVED***10807 because
...
Schema.prototype.interpretAsType = function(path, obj, options) {
    ...
    if (cast) {
      ...
      if (name === void 0) {
        throw new TypeError('Invalid schema configuration: ' +
          ...
          'See https://mongoosejs.com/docs/guide.html***REMOVED***definition for more info on supported schema syntaxes.');
      }
  ...
  if (name === void 0) {
    throw new TypeError(`Invalid schema configuration: \`${path}\` schematype definition is ` +
      'invalid. See ' +
      'https://mongoosejs.com/docs/guide.html***REMOVED***definition for more info on supported schema syntaxes.');
  }
...
/**
 * Iterates the schemas paths similar to Array***REMOVED***forEach.
 *
...
/**
 * ignore. Deprecated re: ***REMOVED***6405
 * @param {Any} self
 * @param {String} path
 * @api private
 */
 ...
 * @param {Object} [options]
 * @param {Boolean} [options.document] If `name` is a hook for both document and query middleware, set to `true` to run on document middleware. For example, set `options.document` to `true` to apply this hook to `Document***REMOVED***deleteOne()` rather than `Query***REMOVED***deleteOne()`.
 ...
 *     fizz.scratch();
 *
 * NOTE: `Schema.method()` adds instance methods to the `Schema.methods` object. You can also add instance methods directly to the `Schema.methods` object as seen in the [guide](https://mongoosejs.com/docs/guide.html***REMOVED***methods)
 *
 ...
 * @param {Function} [fn] The Function in a single-function definition.
 * @api public
 * @see Statics https://mongoosejs.com/docs/guide.html***REMOVED***statics
 */
 ...
 * @param {Object} [options] Options to pass to [MongoDB driver's `createIndex()` function](https://mongodb.github.io/node-mongodb-native/4.9/classes/Collection.html***REMOVED***createIndex)
 ...
 * @see Schema https://mongoosejs.com/docs/api/schema.html***REMOVED***Schema()
 * @api public
 */
 ...
 * @param {Object} [options]
 * @param {String|Model} [options.ref] model name or model instance. Marks this as a [populate virtual](https://mongoosejs.com/docs/populate.html***REMOVED***populate-virtuals).
 * @param {String|Function} [options.localField] Required for populate virtuals. See [populate virtual docs](https://mongoosejs.com/docs/populate.html***REMOVED***populate-virtuals) for more information.
 * @param {String|Function} [options.foreignField] Required for populate virtuals. See [populate virtual docs](https://mongoosejs.com/docs/populate.html***REMOVED***populate-virtuals) for more information.
 ...
 * @param {Object|Function} [options.match=null] Apply a default [`match` option to populate](https://mongoosejs.com/docs/populate.html***REMOVED***match), adding an additional filter to the populate query.
 * @return {VirtualType}
 */
 ...
 * and [instance methods](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Classes***REMOVED***Class_body_and_method_definitions)
 * to schema [virtuals](https://mongoosejs.com/docs/guide.html***REMOVED***virtuals),
 * [statics](https://mongoosejs.com/docs/guide.html***REMOVED***statics), and
 * [methods](https://mongoosejs.com/docs/guide.html***REMOVED***methods).
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
 * ```javascript
 ...
 *
 * - [String](https://mongoosejs.com/docs/schematypes.html***REMOVED***strings)
 * - [Number](https://mongoosejs.com/docs/schematypes.html***REMOVED***numbers)
 * - [Boolean](https://mongoosejs.com/docs/schematypes.html***REMOVED***booleans) | Bool
 ...
 * - [Date](https://mongoosejs.com/docs/schematypes.html***REMOVED***dates)
 * - [ObjectId](https://mongoosejs.com/docs/schematypes.html***REMOVED***objectids) | Oid
 * - [Mixed](https://mongoosejs.com/docs/schematypes.html***REMOVED***mixed)
 * - [UUID](https://mongoosejs.com/docs/schematypes.html***REMOVED***uuid)
 * - [BigInt](https://mongoosejs.com/docs/schematypes.html***REMOVED***bigint)
 *
