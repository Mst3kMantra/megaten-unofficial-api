 ...
 * using JavaScript's built-in `String***REMOVED***toLowerCase()`.
 *
 * @api public
 * @property lowercase
 * @memberOf SchemaStringOptions
 ...
 * whitespace using [JavaScript's built-in `String***REMOVED***trim()`](https://masteringjs.io/tutorials/fundamentals/trim-string).
 *
 * @api public
 * @property trim
 * @memberOf SchemaStringOptions
 ...
 * using JavaScript's built-in [`String***REMOVED***toUpperCase()`](https://masteringjs.io/tutorials/fundamentals/uppercase).
 *
 * @api public
 * @property uppercase
 * @memberOf SchemaStringOptions
...
/**
 * Sets default [populate options](https://mongoosejs.com/docs/populate.html***REMOVED***query-conditions).
 *
 * @api public
 * @property populate
 * @memberOf SchemaStringOptions
