 ...
 *
 * - `maxTimeMS`: Set [`maxTimeMS`](https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.maxTimeMS()) for all queries on this connection.
 ...
 * added to this connection using [`Connection***REMOVED***model()`](https://mongoosejs.com/docs/api/connection.html***REMOVED***Connection.prototype.model()).
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
 ...
 * you have [multiple connections](https://mongoosejs.com/docs/connections.html***REMOVED***multiple_connections).
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
 ...
 *
 * Options are passed down without modification to the [MongoDB driver's `createCollection()` function](https://mongodb.github.io/node-mongodb-native/4.9/classes/Db.html***REMOVED***createCollection)
 *
 ...
 *
 * Calls the MongoDB driver's [`session.withTransaction()`](https://mongodb.github.io/node-mongodb-native/4.9/classes/ClientSession.html***REMOVED***withTransaction),
 ...
 * @param {Object} [options] Passed on to [`MongoClient.connect`](https://mongodb.github.io/node-mongodb-native/4.9/classes/MongoClient.html***REMOVED***connect-1)
...
/**
 * Destroy the connection. Similar to [`.close`](https://mongoosejs.com/docs/api/connection.html***REMOVED***Connection.prototype.close()),
...
Connection.prototype.doClose = function() {
  throw new Error('Connection***REMOVED***doClose unimplemented by driver');
};
 ...
 * @see Mongoose***REMOVED***model https://mongoosejs.com/docs/api/mongoose.html***REMOVED***Mongoose.prototype.model()
 ...
 * [`Model.watch()`](https://mongoosejs.com/docs/api/model.html***REMOVED***Model.watch()).
 *
 ...
 * @param {Object} [options] passed without changes to [the MongoDB driver's `Db***REMOVED***watch()` function](https://mongodb.github.io/node-mongodb-native/4.9/classes/Db.html***REMOVED***watch)
...
Connection.prototype.setClient = function setClient() {
  throw new MongooseError('Connection***REMOVED***setClient not implemented by driver');
};
...
Connection.prototype.createClient = function createClient() {
  throw new MongooseError('Connection***REMOVED***createClient not implemented by driver');
};
...
/**
 * Switches to a different database using the same [connection pool](https://mongoosejs.com/docs/api/connectionshtml***REMOVED***connection_pools).
 *
 ...
 * @param {Boolean} [options.noListener=false] If true, the connection object will not make the db listen to events on the original connection. See [issue ***REMOVED***9961](https://github.com/Automattic/mongoose/issues/9961).
