 ...
 *
 * _Indexes are created [in the background](https://www.mongodb.com/docs/manual/core/index-creation/***REMOVED***index-creation-background)
 ...
 * immutable paths unless the parent document has [`isNew: true`](https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.isNew()).
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
 ...
 * and `updateMany()` based on [strict mode](https://mongoosejs.com/docs/guide.html***REMOVED***strict).
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
 ...
 * validation failed.
 *
 * The error message argument is optional. If not passed, the [default generic error message template](https://mongoosejs.com/docs/api/error.html***REMOVED***Error.messages) will be used.
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
 ...
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Error message templates:
 *
 ...
 *     });
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Asynchronous validation:
 *
 ...
 *
 * Validation occurs `pre('save')` or whenever you manually execute [document***REMOVED***validate](https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.validate()).
 *
 * If validation fails during `pre('save')` and no callback was passed to receive the error, an `error` event will be emitted on your Models associated db [connection](https://mongoosejs.com/docs/api/connection.html***REMOVED***Connection()), passing the validation error object along.
 *
  ...
  for (i = 0, length = arguments.length; i < length; i++) {
    ...
    if (!utils.isPOJO(arg)) {
      const msg = 'Invalid validator. Received (' + typeof arg + ') '
        + arg
        + '. See https://mongoosejs.com/docs/api/schematype.html***REMOVED***SchemaType.prototype.validate()';
 ...
 * @return {SchemaType} this
 * @see Customized Error Messages https://mongoosejs.com/docs/api/error.html***REMOVED***Error.messages
 * @see SchemaArray***REMOVED***checkRequired https://mongoosejs.com/docs/api/schemaarray.html***REMOVED***SchemaArray.prototype.checkRequired()
 * @see SchemaBoolean***REMOVED***checkRequired https://mongoosejs.com/docs/api/schemaboolean.html***REMOVED***SchemaBoolean.prototype.checkRequired()
 * @see SchemaBuffer***REMOVED***checkRequired https://mongoosejs.com/docs/api/schemabuffer.html***REMOVED***SchemaBuffer.prototype.checkRequired()
 * @see SchemaNumber***REMOVED***checkRequired https://mongoosejs.com/docs/api/schemanumber.html***REMOVED***SchemaNumber.prototype.checkRequired()
 * @see SchemaObjectId***REMOVED***checkRequired https://mongoosejs.com/docs/api/schemaobjectid.html***REMOVED***ObjectId.prototype.checkRequired()
 * @see SchemaString***REMOVED***checkRequired https://mongoosejs.com/docs/api/schemastring.html***REMOVED***SchemaString.prototype.checkRequired()
 * @api public
 */
...
SchemaType.prototype.applySetters = function(value, scope, init, priorVal, options) {
  ...
  // do not cast until all setters are applied ***REMOVED***665
