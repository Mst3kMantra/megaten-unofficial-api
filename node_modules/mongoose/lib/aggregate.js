 ...
 * instantiate this class directly, use [Model.aggregate()](https://mongoosejs.com/docs/api/model.html***REMOVED***Model.aggregate()) instead.
 *
 ...
 * @see driver https://mongodb.github.io/node-mongodb-native/4.9/classes/Collection.html***REMOVED***aggregate
 ...
 *
 * - [`allowDiskUse`](https://mongoosejs.com/docs/api/aggregate.html***REMOVED***Aggregate.prototype.allowDiskUse())
 * - `bypassDocumentValidation`
 * - [`collation`](https://mongoosejs.com/docs/api/aggregate.html***REMOVED***Aggregate.prototype.collation())
 * - `comment`
 * - [`cursor`](https://mongoosejs.com/docs/api/aggregate.html***REMOVED***Aggregate.prototype.cursor())
 * - [`explain`](https://mongoosejs.com/docs/api/aggregate.html***REMOVED***Aggregate.prototype.explain())
 * - `fieldsAsRaw`
 * - [`hint`](https://mongoosejs.com/docs/api/aggregate.html***REMOVED***Aggregate.prototype.hint())
 * - `let`
 * - `maxTimeMS`
 * - `raw`
 * - [`readConcern`](https://mongoosejs.com/docs/api/aggregate.html***REMOVED***Aggregate.prototype.readConcern())
 * - `readPreference`
 * - [`session`](https://mongoosejs.com/docs/api/aggregate.html***REMOVED***Aggregate.prototype.session())
 * - `writeConcern`
 *
 * @property options
 * @memberOf Aggregate
 ...
 *
 * Mongoose query [selection syntax](https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.select()) is also supported.
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
 ...
 *
 * @see $lookup https://www.mongodb.com/docs/manual/reference/operator/aggregation/lookup/***REMOVED***pipe._S_lookup
 ...
 *
 * @see $graphLookup https://www.mongodb.com/docs/manual/reference/operator/aggregation/graphLookup/***REMOVED***pipe._S_graphLookup
 ...
 *
 * @see $sample https://www.mongodb.com/docs/manual/reference/operator/aggregation/sample/***REMOVED***pipe._S_sample
 ...
 * @param {Object} [options.collation] object see [`Aggregate.prototype.collation()`](https://mongoosejs.com/docs/api/aggregate.html***REMOVED***Aggregate.prototype.collation())
 * @param {ClientSession} [options.session] ClientSession see [`Aggregate.prototype.session()`](https://mongoosejs.com/docs/api/aggregate.html***REMOVED***Aggregate.prototype.session())
 * @see mongodb https://www.mongodb.com/docs/manual/reference/command/aggregate/
 * @return {Aggregate} this
 * @api public
 */
 ...
 * Like [`.then()`](https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.then), but only takes a rejection handler.
 * Compatible with `await`.
 *
