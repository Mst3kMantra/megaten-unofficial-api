 ...
 *
 * @api public
 * @param {Object} options see [`Mongoose***REMOVED***set()` docs](https://mongoosejs.com/docs/api/mongoose.html***REMOVED***Mongoose.prototype.set())
 */
 ...
 * - `timestamps.createdAt.immutable`: `true` by default. If `false`, it will change the `createdAt` field to be [`immutable: false`](https://mongoosejs.com/docs/api/schematype.html***REMOVED***SchemaType.prototype.immutable) which means you can update the `createdAt`
 ...
 * - `runValidators`: `false` by default. Set to true to enable [update validators](https://mongoosejs.com/docs/validation.html***REMOVED***update-validators) for all validators by default.
 * - `sanitizeFilter`: `false` by default. Set to true to enable the [sanitization of the query filters](https://mongoosejs.com/docs/api/mongoose.html***REMOVED***Mongoose.prototype.sanitizeFilter()) against query selector injection attacks by wrapping any nested objects that have a property whose name starts with `$` in a `$eq`.
 * - `selectPopulatedPaths`: `true` by default. Set to false to opt out of Mongoose adding all fields that you `populate()` to your `select()`. The schema-level option `selectPopulatedPaths` overwrites this one.
 * - `strict`: `true` by default, may be `false`, `true`, or `'throw'`. Sets the default strict mode for schemas.
 * - `strictQuery`: `false` by default. May be `false`, `true`, or `'throw'`. Sets the default [strictQuery](https://mongoosejs.com/docs/guide.html***REMOVED***strictQuery) mode for schemas.
 * - `toJSON`: `{ transform: true, flattenDecimals: true }` by default. Overwrites default objects to [`toJSON()`](https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.toJSON()), for determining how Mongoose documents get serialized by `JSON.stringify()`
 * - `toObject`: `{ transform: true, flattenDecimals: true }` by default. Overwrites default objects to [`toObject()`](https://mongoosejs.com/docs/api/document.html***REMOVED***Document.prototype.toObject())
 *
 ...
 * @param {Boolean} [options.bufferCommands=true] Mongoose specific option. Set to false to [disable buffering](https://mongoosejs.com/docs/faq.html***REMOVED***callback_never_executes) on all models associated with this connection.
 ...
 * @param {Class} [options.promiseLibrary] Sets the [underlying driver's promise library](https://mongodb.github.io/node-mongodb-native/4.9/interfaces/MongoClientOptions.html***REMOVED***promiseLibrary).
 ...
 * @param {Number} [options.socketTimeoutMS=0] How long the MongoDB driver will wait before killing a socket due to inactivity _after initial connection_. Defaults to 0, which means Node.js will not time out the socket due to inactivity. A socket may be inactive because of either no activity or a long-running operation. This option is passed to [Node.js `socket***REMOVED***setTimeout()` function](https://nodejs.org/api/net.html***REMOVED***net_socket_settimeout_timeout_callback) after the MongoDB driver successfully completes.
 * @param {Number} [options.family=0] Passed transparently to [Node.js' `dns.lookup()`](https://nodejs.org/api/dns.html***REMOVED***dns_dns_lookup_hostname_options_callback) function. May be either `0`, `4`, or `6`. `4` means use IPv4 only, `6` means use IPv6 only, `0` means try both.
 ...
 * @param {Boolean} [options.autoIndex=true] Mongoose-specific option. Set to false to disable automatic index creation for all models associated with this connection.
 * @param {Class} [options.promiseLibrary] Sets the [underlying driver's promise library](https://mongodb.github.io/node-mongodb-native/4.9/interfaces/MongoClientOptions.html***REMOVED***promiseLibrary).
 * @param {Number} [options.socketTimeoutMS=0] How long the MongoDB driver will wait before killing a socket due to inactivity _after initial connection_. A socket may be inactive because of either no activity or a long-running operation. `socketTimeoutMS` defaults to 0, which means Node.js will not time out the socket due to inactivity. This option is passed to [Node.js `socket***REMOVED***setTimeout()` function](https://nodejs.org/api/net.html***REMOVED***net_socket_settimeout_timeout_callback) after the MongoDB driver successfully completes.
 * @param {Number} [options.family=0] Passed transparently to [Node.js' `dns.lookup()`](https://nodejs.org/api/dns.html***REMOVED***dns_dns_lookup_hostname_options_callback) function. May be either `0`, `4`, or `6`. `4` means use IPv4 only, `6` means use IPv6 only, `0` means try both.
 * @param {Boolean} [options.autoCreate=false] Set to `true` to make Mongoose automatically call `createCollection()` on every model created on this connection.
 * @param {Function} [callback]
 * @see Mongoose***REMOVED***createConnection https://mongoosejs.com/docs/api/mongoose.html***REMOVED***Mongoose.prototype.createConnection()
 * @api public
 ...
 * starts a session on the [default mongoose connection](https://mongoosejs.com/docs/api/mongoose.html***REMOVED***Mongoose.prototype.connection).
 *
...
/**
 * The Mongoose module's default connection. Equivalent to `mongoose.connections[0]`, see [`connections`](https://mongoosejs.com/docs/api/mongoose.html***REMOVED***Mongoose.prototype.connections).
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
 *     const mongoose = require('mongoose');
 ...
 *
 * This is the connection used by default for every model created using [mongoose.model](https://mongoosejs.com/docs/api/mongoose.html***REMOVED***Mongoose.prototype.model()).
 *
 * To create a new connection, use [`createConnection()`](https://mongoosejs.com/docs/api/mongoose.html***REMOVED***Mongoose.prototype.createConnection()).
 *
 * @memberOf Mongoose
 * @instance
 ...
 * [`createConnection()`](https://mongoosejs.com/docs/api/mongoose.html***REMOVED***Mongoose.prototype.createConnection()) adds a connection
 * to this array.
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
 ...
 * [`createConnection()`](https://mongoosejs.com/docs/api/mongoose.html***REMOVED***Mongoose.prototype.createConnection()) increments
 * this value.
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
...
/**
 * The Mongoose [Connection](https://mongoosejs.com/docs/api/connection.html***REMOVED***Connection()) constructor
 *
 * @memberOf Mongoose
 * @instance
 * @method Connection
...
/**
 * The Mongoose [SchemaType](https://mongoosejs.com/docs/api/schematype.html***REMOVED***SchemaType()) constructor
 *
 * @method SchemaType
 * @api public
 */
 ...
 * - [Decimal128](https://mongoosejs.com/docs/api/mongoose.html***REMOVED***Mongoose.prototype.Decimal128)
...
/**
 * The Mongoose [Query](https://mongoosejs.com/docs/api/query.html***REMOVED***Query()) constructor.
 *
 * @method Query
 * @api public
 */
...
/**
 * The Mongoose [Model](https://mongoosejs.com/docs/api/model.html***REMOVED***Model()) constructor.
 *
 * @method Model
 * @api public
 */
...
/**
 * The Mongoose [Document](https://mongoosejs.com/docs/api/document.html***REMOVED***Document()) constructor.
 *
 * @method Document
 * @api public
 */
 ...
 * [timestamps](https://mongoosejs.com/docs/guide.html***REMOVED***timestamps). You may stub out this function
