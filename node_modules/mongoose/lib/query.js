 ...
 * [`Model.find()`](https://mongoosejs.com/docs/api/model.html***REMOVED***Model.find()).
 *
...
function Query(conditions, options, model, collection) {
  // this stuff is for dealing with custom queries created by ***REMOVED***toConstructor
 ...
 * @return {Query} this
 * @see mongodb https://www.mongodb.com/docs/manual/tutorial/query-documents/***REMOVED***projection
 * @see $slice https://www.mongodb.com/docs/manual/reference/projection/slice/***REMOVED***prj._S_slice
 * @api public
 */
 ...
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Note:
 *
 * As of Mongoose 3.7, `$geoWithin` is always used for queries. To change this behavior, see [Query.use$geoWithin](https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.use$geoWithin).
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Note:
 *
 ...
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Preferences:
 *
 * ```
 ...
 *
 * Read more about how to use read preferences [here](https://www.mongodb.com/docs/manual/applications/replication/***REMOVED***read-preference).
 *
 * @method read
 * @memberOf Query
 * @instance
 ...
 * @see mongodb https://www.mongodb.com/docs/manual/applications/replication/***REMOVED***read-preference
 * @return {Query} this
 * @api public
 */
 ...
 * @see Connection.prototype.startSession() https://mongoosejs.com/docs/api/connection.html***REMOVED***Connection.prototype.startSession()
 * @see mongoose.startSession() https://mongoosejs.com/docs/api/mongoose.html***REMOVED***Mongoose.prototype.startSession()
 * @return {Query} this
 * @api public
 */
 ...
 * - `wtimeout`: If [`w > 1`](https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.w()), the maximum amount of time to wait for this write to propagate through the replica set before this operation fails. The default is `0`, which means no timeout.
 *
 ...
 * - `updateMany()`
 *
 * Defaults to the schema's [`writeConcern` option](https://mongoosejs.com/docs/guide.html***REMOVED***writeConcern)
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
 ...
 * - `updateMany()`
 *
 * Defaults to the schema's [`writeConcern.w` option](https://mongoosejs.com/docs/guide.html***REMOVED***writeConcern)
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
 *     // The 'majority' option means the `deleteOne()` promise won't resolve
 ...
 * @memberOf Query
 * @instance
 * @param {String|number} val 0 for fire-and-forget, 1 for acknowledged by one server, 'majority' for majority of the replica set, or [any of the more advanced options](https://www.mongodb.com/docs/manual/reference/write-concern/***REMOVED***w-option).
 * @see mongodb https://www.mongodb.com/docs/manual/reference/write-concern/***REMOVED***w-option
 * @return {Query} this
 * @api public
 */
 ...
 * - `updateMany()`
 *
 * Defaults to the schema's [`writeConcern.j` option](https://mongoosejs.com/docs/guide.html***REMOVED***writeConcern)
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
 ...
 * @instance
 * @param {boolean} val
 * @see mongodb https://www.mongodb.com/docs/manual/reference/write-concern/***REMOVED***j-option
 * @return {Query} this
 * @api public
 */
...
/**
 * If [`w > 1`](https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.w()), the maximum amount of time to
 ...
 * - `updateMany()`
 *
 * Defaults to the schema's [`writeConcern.wtimeout` option](https://mongoosejs.com/docs/guide.html***REMOVED***writeConcern)
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
 ...
 * @see mongodb https://www.mongodb.com/docs/manual/reference/write-concern/***REMOVED***wtimeout
 * @return {Query} this
 * @api public
 */
 ...
 *
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Read Concern Level:
 *
 * ```
 ...
 * - [readPreference](https://www.mongodb.com/docs/manual/applications/replication/***REMOVED***read-preference)
 ...
 * - [timestamps](https://mongoosejs.com/docs/guide.html***REMOVED***timestamps): If `timestamps` is set in the schema, set this option to `false` to skip timestamps for that particular update. Has no effect if `timestamps` is not enabled in the schema options.
 ...
 *
 * - [lean](https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.lean())
 * - [populate](https://mongoosejs.com/docs/populate.html)
 * - [projection](https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.projection())
 * - sanitizeProjection
 * - useBigInt64
 *
 ...
 *
 * - [strict](https://mongoosejs.com/docs/guide.html***REMOVED***strict)
 ...
 * with [cursors](https://mongoosejs.com/docs/queries.html***REMOVED***streaming).
 *
 ...
 *
 * - `populate`: an array representing what paths will be populated. Should have one entry for each call to [`Query.prototype.populate()`](https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.populate())
 * - `lean`: if truthy, Mongoose will not [hydrate](https://mongoosejs.com/docs/api/model.html***REMOVED***Model.hydrate()) any documents that are returned from this query. See [`Query.prototype.lean()`](https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.lean()) for more information.
 * - `strict`: controls how Mongoose handles keys that aren't in the schema for updates. This option is `true` by default, which means Mongoose will silently strip any paths in the update that aren't in the schema. See the [`strict` mode docs](https://mongoosejs.com/docs/guide.html***REMOVED***strict) for more information.
 * - `strictQuery`: controls how Mongoose handles keys that aren't in the schema for the query `filter`. This option is `false` by default, which means Mongoose will allow `Model.find({ foo: 'bar' })` even if `foo` is not in the schema. See the [`strictQuery` docs](https://mongoosejs.com/docs/guide.html***REMOVED***strictQuery) for more information.
 * - `nearSphere`: use `$nearSphere` instead of `near()`. See the [`Query.prototype.nearSphere()` docs](https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.nearSphere())
 *
 ...
 * [`Query.prototype.cursor()`](https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.cursor())
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Example:
 *
 ...
 * @param {Object} value
 * @return {Query} this
 * @see MongoDB docs https://www.mongodb.com/docs/manual/reference/method/cursor.collation/***REMOVED***cursor.collation
 * @api public
 */
 ...
 * @param {Object} [options] see [`setOptions()`](https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.setOptions())
 * @param {Boolean} [options.translateAliases=null] If set to `true`, translates any schema-defined aliases in `filter`, `projection`, `update`, and `distinct`. Throws an error if there are any conflicts where both alias and raw property are defined on the same object.
 * @return {Query} this
 * @see findOne https://www.mongodb.com/docs/manual/reference/method/db.collection.findOne/
 * @see Query.select https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.select()
 * @api public
 */
 ...
 *
 * @see countDocuments https://mongodb.github.io/node-mongodb-native/4.9/classes/Collection.html***REMOVED***countDocuments
 * @api private
 */
 ...
 *
 * @see estimatedDocumentCount https://mongodb.github.io/node-mongodb-native/4.9/classes/Collection.html***REMOVED***estimatedDocumentCount
 * @api private
 */
 ...
 * a collection, e.g. `count({})`, use the [`estimatedDocumentCount()` function](https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.estimatedDocumentCount())
 * instead. Otherwise, use the [`countDocuments()`](https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.countDocuments()) function instead.
 *
 * This function triggers the following middleware.
 *
 * - `count()`
 ...
 * [`$where` and a couple geospatial operators](https://mongodb.github.io/node-mongodb-native/4.9/classes/Collection.html***REMOVED***countDocuments).
 * versus `count()`.
 *
 * This function triggers the following middleware.
 *
 ...
 *
 * This function calls the MongoDB driver's [`Collection***REMOVED***deleteOne()` function](https://mongodb.github.io/node-mongodb-native/4.9/classes/Collection.html***REMOVED***deleteOne).
 ...
 * @see deleteOne https://mongodb.github.io/node-mongodb-native/4.9/classes/Collection.html***REMOVED***deleteOne
 * @api public
 */
 ...
 *
 * This function calls the MongoDB driver's [`Collection***REMOVED***deleteMany()` function](https://mongodb.github.io/node-mongodb-native/4.9/classes/Collection.html***REMOVED***deleteMany).
 * The returned [promise](https://mongoosejs.com/docs/queries.html) resolves to an
 * object that contains 3 properties:
 *
 * - `ok`: `1` if no errors occurred
 ...
 * @return {Query} this
 * @see DeleteResult https://mongodb.github.io/node-mongodb-native/4.9/interfaces/DeleteResult.html
 * @see deleteMany https://mongodb.github.io/node-mongodb-native/4.9/classes/Collection.html***REMOVED***deleteMany
 * @api public
 */
 ...
 * - `findOneAndUpdate()`
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Available options
 *
 ...
 * - `runValidators`: if true, runs [update validators](https://mongoosejs.com/docs/validation.html***REMOVED***update-validators) on this command. Update validators validate the update operation against the model's schema.
 ...
 * @see findOneAndUpdate https://mongodb.github.io/node-mongodb-native/4.9/classes/Collection.html***REMOVED***findOneAndUpdate
 * @return {Query} this
 * @api public
 */
...
Query.prototype._findOneAndUpdate = async function _findOneAndUpdate() {
  // For backwards compability with Mongoose 6 re: ***REMOVED***13550
 ...
 * - `rawResult`: if true, resolves to the [raw result from the MongoDB driver](https://mongodb.github.io/node-mongodb-native/4.9/interfaces/ModifyResult.html)
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Callback Signature
 *
 *     function(error, doc) {
  ...
  if (isOverwriting) {
    if (op === 'updateOne' || op === 'updateMany') {
      throw new MongooseError('The MongoDB server disallows ' +
        ...
        'https://mongoosejs.com/docs/deprecations.html***REMOVED***update');
    }
 ...
 *
 * @see Model.update https://mongoosejs.com/docs/api/model.html***REMOVED***Model.update()
 * @method _updateMany
 * @memberOf Query
 * @instance
 * @api private
 ...
 *
 * @see Model.replaceOne https://mongoosejs.com/docs/api/model.html***REMOVED***Model.replaceOne()
 * @method _replaceOne
 * @memberOf Query
 * @instance
 * @api private
 ...
 *
 * - Use `replaceOne()` if you want to overwrite an entire document rather than using [atomic operators](https://www.mongodb.com/docs/manual/tutorial/model-data-for-atomic-operations/***REMOVED***pattern) like `$set`.
 *
 ...
 * MongoDB will replace the existing document and will not accept any [atomic operators](https://www.mongodb.com/docs/manual/tutorial/model-data-for-atomic-operations/***REMOVED***pattern) (`$set`, etc.)
 *
 ...
 * @see Query***REMOVED***select https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.select()
 * @see Model.populate https://mongoosejs.com/docs/api/model.html***REMOVED***Model.populate()
 * @return {Query} this
 * @api public
 */
 ...
 *     }
 *
 * ***REMOVED******REMOVED******REMOVED******REMOVED*** Valid options
 *
 ...
 * @return {Query} this
 * @see $geometry https://www.mongodb.com/docs/manual/reference/operator/geometry/
 * @see Geospatial Support Enhancements https://www.mongodb.com/docs/manual/release-notes/2.4/***REMOVED***geospatial-support-enhancements
 ...
 *
 * @deprecated
 * @see near() https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.near()
 * @see $near https://www.mongodb.com/docs/manual/reference/operator/near/
 * @see $nearSphere https://www.mongodb.com/docs/manual/reference/operator/nearSphere/
 * @see $maxDistance https://www.mongodb.com/docs/manual/reference/operator/maxDistance/
 */
 ...
 * enable async iterators in Node.js 8.x using the [`--harmony_async_iteration` flag](https://github.com/tc39/proposal-async-iteration/issues/117***REMOVED***issuecomment-346695187).
 *
 ...
 * @instance
 * @see $box https://www.mongodb.com/docs/manual/reference/operator/box/
 * @see within() Query***REMOVED***within https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.within()
 * @see MongoDB Geospatial Indexing https://www.mongodb.com/docs/manual/core/geospatial-indexes/
...
/**
 * _DEPRECATED_ Alias for [circle](https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.circle())
 *
 * **Deprecated.** Use [circle](https://mongoosejs.com/docs/api/query.html***REMOVED***Query.prototype.circle()) instead.
 *
 * @deprecated
 * @method center
 * @memberOf Query
