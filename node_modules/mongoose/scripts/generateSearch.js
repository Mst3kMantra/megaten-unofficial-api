  ...
  if (file.api) {
    for (const prop of file.props) {
      const content = new Content({
        ...
        url: `${filename}***REMOVED***${prop.anchorId}`
      });
    ...
    $('h3').each((index, el) => {
      ...
      const content = new Content({
        ...
        body: html,
        url: `${filename.replace('.md', '.html').replace(/^docs/, '')}***REMOVED***${el.prop('id')}`
      });
    ...
    $('h3').each((index, el) => {
      ...
      const content = new Content({
        title: `${file.title}: ${title}`,
        body: html,
        url: `${filename.replace('.pug', '.html').replace(/^docs/, '')}***REMOVED***${el.prop('id')}`
      });
