...
0.8.4 / 2021-09-01
==================
 * fix: throw error if `parts` contains an element that isn't a string or number ***REMOVED***13
...
0.8.2 / 2020-12-30
==================
 * fix(stringToParts): fall back to legacy treatment for square brackets if square brackets contents aren't a number Automattic/mongoose***REMOVED***9640
 * chore: add eslint
...
0.7.0 / 2020-03-24
==================
 * BREAKING CHANGE: remove `component.json` ***REMOVED***9 [AlexeyGrigorievBoost](https://github.com/AlexeyGrigorievBoost)
...
0.4.1 / 2018-04-08
==================
 * fix: allow opting out of weird `$` set behavior re: Automattic/mongoose***REMOVED***6273
...
==================
  ...
  * test; added for ***REMOVED***5
  * fix typo that breaks set ***REMOVED***5 [Contra](https://github.com/Contra)
...
==================
  ...
  * add support for using module as a component ***REMOVED***2 [Contra](https://github.com/Contra)
