...
Dotenv es un módulo de dependencia cero que carga las variables de entorno desde un archivo `.env` en [`process.env`](https://nodejs.org/docs/latest/api/process.html***REMOVED***process_process_env). El almacenamiento de la configuración del entorno separado del código está basado en la metodología [The Twelve-Factor App](http://12factor.net/config).

[![js-standard-style](https://img.shields.io/badge/code%20style-standard-brightgreen.svg?style=flat-square)](https://github.com/feross/standard)
[![LICENSE](https://img.shields.io/github/license/motdotla/dotenv.svg)](LICENSE)

***REMOVED******REMOVED*** Instalación

```bash
***REMOVED*** instalación local (recomendado)
...
```javascript
import * as dotenv from 'dotenv' // vea en https://github.com/motdotla/dotenv***REMOVED***como-uso-dotenv-con-import
...
***REMOVED******REMOVED******REMOVED*** Valores multilínea
...
***REMOVED******REMOVED******REMOVED*** Comentarios
...
Los comentarios comienzan donde existe un `***REMOVED***`, entonces, si su valor contiene un `***REMOVED***`, enciérrelo entre comillas. Este es un cambio importante desde la versión `>= v15.0.0` en adelante.

***REMOVED******REMOVED******REMOVED*** Análisis
...
***REMOVED******REMOVED******REMOVED*** Precarga

Puede usar el `--require` (`-r`) [opción de línea de comando](https://nodejs.org/api/cli.html***REMOVED***-r---require-module) para precargar dotenv. Al hacer esto, no necesita requerir ni cargar dotnev en el código de su aplicación.
...
***REMOVED******REMOVED******REMOVED*** Expansión Variable
...
***REMOVED******REMOVED******REMOVED*** Sincronizando
...
***REMOVED******REMOVED******REMOVED*** Configuración

`Configuración` leerá su archivo `.env`, analizará el contenido, lo asignará a [`process.env`](https://nodejs.org/docs/latest/api/process.html***REMOVED***process_process_env),
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Opciones

***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** Ruta
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** Codificación
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** Depurar
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** Anular
...
***REMOVED******REMOVED******REMOVED*** Analizar
...
***REMOVED******REMOVED******REMOVED*** ¿Por qué el archivo `.env` no carga mis variables de entorno correctamente?
...
***REMOVED******REMOVED******REMOVED*** ¿Debo confirmar mi archivo `.env`?
...
***REMOVED******REMOVED******REMOVED*** ¿Debería tener multiples archivos `.env`?
...
***REMOVED******REMOVED******REMOVED*** ¿Qué reglas sigue el motor de análisis?
...
- las líneas que comienzan con `***REMOVED***` se tratan como comentarios
- `***REMOVED***` marca el comienzo de un comentario (a menos que el valor esté entre comillas)
...
***REMOVED******REMOVED******REMOVED*** ¿Qué sucede con las variables de entorno que ya estaban configuradas?
...
***REMOVED******REMOVED******REMOVED*** ¿Por qué mis variables de entorno no aparecen para React?
...
***REMOVED******REMOVED******REMOVED*** ¿Puedo personalizar/escribir plugins para dotenv?
...
***REMOVED******REMOVED******REMOVED*** Cómo uso dotnev con `import`?

Simplemente..

```javascript
// index.mjs (ESM)
import * as dotenv from 'dotenv' // vea https://github.com/motdotla/dotenv***REMOVED***como-uso-dotenv-con-import
dotenv.config()
import express from 'express'
```
...
2. Cree un archivo separado que ejecutará `config` primero como se describe en [este comentario ***REMOVED***133](https://github.com/motdotla/dotenv/issues/133***REMOVED***issuecomment-255298822)

***REMOVED******REMOVED******REMOVED*** ¿Qué pasa con la expansión de variable?

Prueba [dotenv-expand](https://github.com/motdotla/dotenv-expand)

***REMOVED******REMOVED******REMOVED*** ¿Qué pasa con la sincronización y la seguridad de los archivos .env?

Vea [dotenv-vault](https://github.com/dotenv-org/dotenv-vault)

***REMOVED******REMOVED*** Guía de contribución

Vea [CONTRIBUTING.md](CONTRIBUTING.md)

***REMOVED******REMOVED*** REGISTRO DE CAMBIOS

Vea [CHANGELOG.md](CHANGELOG.md)

***REMOVED******REMOVED*** ¿Quiénes utilizan dotenv?
