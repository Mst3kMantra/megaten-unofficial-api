...
***REMOVED******REMOVED******REMOVED******REMOVED*** `var bits = bitfield([options])`
...
***REMOVED******REMOVED******REMOVED******REMOVED*** `bits.set(index, value)`

Set a bit to true or false.

***REMOVED******REMOVED******REMOVED******REMOVED*** `bits.get(index)`

Get the value of a bit.

***REMOVED******REMOVED******REMOVED******REMOVED*** `bits.pages`
...
***REMOVED******REMOVED******REMOVED******REMOVED*** `var buffer = bits.toBuffer()`
