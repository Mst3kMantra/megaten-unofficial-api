...
module.exports = function runSymbolTests(t) {
	...
	*/
	...
	t.equal(typeof Symbol.prototype.toString, 'function', 'Symbol***REMOVED***toString is a function');
	// t.equal(String(foo), Symbol.prototype.toString.call(foo), 'Symbol***REMOVED***toString equals String of the same symbol');
	...
	t.equal(Object.prototype.toString.call(sym), '[object Symbol]', 'symbol primitive Object***REMOVED***toStrings properly');
	t.equal(Object.prototype.toString.call(symObj), '[object Symbol]', 'symbol primitive Object***REMOVED***toStrings properly');
