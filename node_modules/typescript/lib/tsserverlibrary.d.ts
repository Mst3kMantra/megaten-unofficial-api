...
declare namespace ts {
    namespace server {
        ...
        namespace protocol {
            ...
            interface ExternalFile {
                ...
                /**
                 * Whether file has mixed content (i.e. .cshtml file that combines html markup with C***REMOVED***/JavaScript)
                 */
            ...
            interface UserPreferences {
                 ...
                 * [Unicode Collation Algorithm](https://unicode.org/reports/tr10/***REMOVED***Scope)) using rules associated with the locale
    ...
    /** Class***REMOVED***method reference in JSDoc */
    ...
    interface ModuleResolutionHost {
         ...
         * @see https://nodejs.org/api/fs.html***REMOVED***fs_fs_realpathsync_path_options
         */
    ...
    interface System {
        ...
        /**
         * A good implementation is node.js' `crypto.createHash`. (https://nodejs.org/api/crypto.html***REMOVED***crypto_crypto_createhash_algorithm)
         */
        createHash?(data: string): string;
    ...
    enum OutliningSpanKind {
        ...
        Comment = "comment",
        /** Sections marked by '// ***REMOVED***region' and '// ***REMOVED***endregion' comments */
        Region = "region",
