...
interface DisposableStack {
     ...
     * ```ts
     * class C {
     *   ***REMOVED***res1: Disposable;
     *   ***REMOVED***res2: Disposable;
     *   ***REMOVED***disposables: DisposableStack;
     *   constructor() {
     *     // stack will be disposed when exiting constructor for any reason
     *     using stack = new DisposableStack();
     * 
     *     // get first resource
     *     this.***REMOVED***res1 = stack.use(getResource1());
     * 
     *     // get second resource. If this fails, both `stack` and `***REMOVED***res1` will be disposed.
     *     this.***REMOVED***res2 = stack.use(getResource2());
     * 
     *     // all operations succeeded, move resources out of `stack` so that they aren't disposed
     *     // when constructor exits
     *     this.***REMOVED***disposables = stack.move();
     *   }
     * 
     *   [Symbol.dispose]() {
     *     this.***REMOVED***disposables.dispose();
     *   }
     * }
     * ```
     */
