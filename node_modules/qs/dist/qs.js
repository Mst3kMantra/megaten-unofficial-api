...
var interpretNumericEntities = function (str) {
    return str.replace(/&***REMOVED***(\d+);/g, function ($0, numberStr) {
...
var isoSentinel = 'utf8=%26%2310003%3B'; // encodeURIComponent('&***REMOVED***10003;')
...
module.exports = function (object, opts) {
    ...
    if (options.charsetSentinel) {
        if (options.charset === 'iso-8859-1') {
            // encodeURIComponent('&***REMOVED***10003;'), the "numeric entity" representation of a checkmark
...
/* adapted from https://github.com/lodash/lodash/blob/4.17.15/dist/lodash.js***REMOVED***L6735-L6744 */
