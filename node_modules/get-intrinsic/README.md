***REMOVED*** get-intrinsic <sup>[![Version Badge][npm-version-svg]][package-url]</sup>
...
See the syntax described [in the JS spec](https://tc39.es/ecma262/***REMOVED***sec-well-known-intrinsic-objects) for reference.
...
[dev-deps-url]: https://david-dm.org/ljharb/get-intrinsic***REMOVED***info=devDependencies
