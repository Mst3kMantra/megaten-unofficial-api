...
***REMOVED******REMOVED******REMOVED*** What it's useful for:
...
***REMOVED******REMOVED*** Breaking Changes with 2.0
...
***REMOVED******REMOVED*** Breaking Changes with 3.0
...
***REMOVED******REMOVED******REMOVED*** Constructing a smart-buffer
...
***REMOVED******REMOVED*** Reading Numeric Values
...
***REMOVED******REMOVED******REMOVED*** SmartBuffer.readString( [length] )
***REMOVED******REMOVED******REMOVED*** SmartBuffer.readString( [encoding] )
***REMOVED******REMOVED******REMOVED*** SmartBuffer.readString( [length], [encoding] )
...
***REMOVED******REMOVED*** Reading Buffer Values

***REMOVED******REMOVED******REMOVED*** SmartBuffer.readBuffer( length )
...
***REMOVED******REMOVED******REMOVED*** SmartBuffer.readBufferNT()
...
***REMOVED******REMOVED*** Writing Numeric Values
...
The following signature is the same for all the above ***REMOVED***

***REMOVED******REMOVED******REMOVED*** SmartBuffer.writeInt8( value, [offset] )
...
***REMOVED******REMOVED*** Writing String Values

When reading String values, you can either choose to write a null terminated string, or a non null terminated string.

***REMOVED******REMOVED******REMOVED*** SmartBuffer.writeStringNT( value, [offset], [encoding] )
***REMOVED******REMOVED******REMOVED*** SmartBuffer.writeStringNT( value, [offset] )
***REMOVED******REMOVED******REMOVED*** SmartBuffer.writeStringNT( value, [encoding] )
...
***REMOVED******REMOVED******REMOVED*** SmartBuffer.writeString( value, [offset], [encoding] )
***REMOVED******REMOVED******REMOVED*** SmartBuffer.writeString( value, [offset] )
***REMOVED******REMOVED******REMOVED*** SmartBuffer.writeString( value, [encoding] )
> `String` **String value to write**
...
***REMOVED******REMOVED*** Writing Buffer Values

***REMOVED******REMOVED******REMOVED*** SmartBuffer.writeBuffer( value, [offset] )
...
***REMOVED******REMOVED******REMOVED*** SmartBuffer.writeBufferNT( value, [offset] )
> `Buffer` **Buffer value to write**
...
***REMOVED******REMOVED******REMOVED*** SmartBuffer.rewind( value )
...
***REMOVED******REMOVED******REMOVED*** SmartBuffer.length
