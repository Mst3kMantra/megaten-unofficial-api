...
export interface NextFunction {
     ...
     * @see {https://expressjs.com/en/guide/using-middleware.html***REMOVED***middleware.router}
     */
    (deferToNext: "router"): void;
    /**
     * "Break-out" of a route by calling {next('route')};
     * @see {https://expressjs.com/en/guide/using-middleware.html***REMOVED***middleware.application}
     */
 ...
 *
 * @see https://expressjs.com/en/api.html***REMOVED***req.params
 *
 * @example
...
> extends http.ServerResponse, Express.Response {
     ...
     * @link http://expressjs.com/4x/api.html***REMOVED***res.sendStatus
     *
     * Examples:
     *
