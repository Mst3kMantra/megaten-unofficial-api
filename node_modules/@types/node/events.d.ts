...
declare module "events" {
    ...
    class EventEmitter {
         ...
         * given event.
         *
         * This method is intentionally generic and works with the web platform [EventTarget](https://dom.spec.whatwg.org/***REMOVED***interface-eventtarget) interface, which has no special`'error'` event
        ...
        /**
         * Value: [boolean](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures***REMOVED***Boolean_type)
         *
