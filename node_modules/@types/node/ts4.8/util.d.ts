...
declare module "util" {
     ...
     *   err &***REMOVED***x26;&***REMOVED***x26; Object.hasOwn(err, 'reason') &***REMOVED***x26;&***REMOVED***x26; err.reason === null;  // true
     * });
     * ```
     * @since v8.2.0
    ...
    global {
         ...
         * https://nodejs.org/api/globals.html***REMOVED***textdecoder
         * @since v11.0.0
         */
         ...
         * https://nodejs.org/api/globals.html***REMOVED***textencoder
         * @since v11.0.0
         */
...
declare module "util/types" {
     ...
     *
     * ```c
     * ***REMOVED***include <js_native_api.h>
     * ***REMOVED***include <stdlib.h>
     * napi_value result;
     * static napi_value MyNapi(napi_env env, napi_callback_info info) {
     *   int* raw = (int*) malloc(1024);
     *   napi_status status = napi_create_external(env, (void*) raw, NULL, NULL, &***REMOVED***x26;result);
     *   if (status != napi_ok) {
    ...
    /**
     * Returns `true` if the value is an instance of a [Module Namespace Object](https://tc39.github.io/ecma262/***REMOVED***sec-module-namespace-exotic-objects).
     *
     * ```js
    ...
    /**
     * Returns `true` if the value was returned by the constructor of a [built-in `Error` type](https://tc39.es/ecma262/***REMOVED***sec-error-objects).
     *
     * ```js
     ...
     * which come from a different [realm](https://tc39.es/ecma262/***REMOVED***realm) while `instanceof Error` returns `false`for these errors:
     *
     * ```js
