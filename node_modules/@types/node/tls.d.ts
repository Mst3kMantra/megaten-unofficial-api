...
declare module "tls" {
    ...
    class TLSSocket extends net.Socket {
         ...
         * Registry](https://www.iana.org/assignments/tls-parameters/tls-parameters.xhtml***REMOVED***exporter-labels).
     ...
     * failure. On success, returns [undefined](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures***REMOVED***Undefined_type).
     *
