...
declare module "crypto" {
     ...
     *
     * `<keygen>` is deprecated since [HTML 5.2](https://www.w3.org/TR/html52/changes.html***REMOVED***features-removed) and new projects
    ...
    namespace constants {
        // https://nodejs.org/dist/latest-v20.x/docs/api/crypto.html***REMOVED***crypto-constants
    ...
    // https://nodejs.org/api/buffer.html***REMOVED***buffer_buffers_and_character_encodings
    ...
    class KeyObject {
         ...
         * ignored.
         *
         * PKCS***REMOVED***1, SEC1, and PKCS***REMOVED***8 type keys can be encrypted by using a combination of
         * the `cipher` and `format` options. The PKCS***REMOVED***8 `type` can be used with any`format` to encrypt any key algorithm (RSA, EC, or DH) by specifying a`cipher`. PKCS***REMOVED***1 and SEC1 can only be
         * encrypted by specifying a `cipher`when the PEM `format` is used. For maximum compatibility, use PKCS***REMOVED***8 for
         * encrypted private keys. Since PKCS***REMOVED***8 defines its own
         * encryption mechanism, PEM-level encryption is not supported when encrypting
         * a PKCS***REMOVED***8 key. See [RFC 5208](https://www.rfc-editor.org/rfc/rfc5208.txt) for PKCS***REMOVED***8 encryption and [RFC 1421](https://www.rfc-editor.org/rfc/rfc1421.txt) for
         * PKCS***REMOVED***1 and SEC1 encryption.
         * @since v11.6.0
         */
     ...
     * modp1  ***REMOVED***  768 bits
     * modp2  ***REMOVED*** 1024 bits
     * modp5  ***REMOVED*** 1536 bits
     * modp14 ***REMOVED*** 2048 bits
     * modp15 ***REMOVED*** etc.
     * modp16
     * modp17
     * modp18
     ...
     * implementation avoids [modulo bias](https://en.wikipedia.org/wiki/Fisher%E2%80%93Yates_shuffle***REMOVED***Modulo_bias).
     *
    ...
    namespace webcrypto {
        ...
        interface SubtleCrypto {
             ...
             * - `'HKDF'`
             * - `'PBKDF2'`
             * @param keyUsages See {@link https://nodejs.org/docs/latest/api/webcrypto.html***REMOVED***cryptokeyusages Key usages}.
             * @since v15.0.0
             */
            deriveKey(
