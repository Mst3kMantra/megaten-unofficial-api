...
declare module "http" {
    ...
    interface ClientRequestArgs {
        ...
        // https://github.com/nodejs/node/blob/master/lib/_http_client.js***REMOVED***L278
        createConnection?:
    ...
    class ClientRequest extends OutgoingMessage {
         ...
         *       if (req.reusedSocket &***REMOVED***x26;&***REMOVED***x26; err.code === 'ECONNRESET') {
         *         retriableRequest();
         *       }
         *     });
         * }
    ...
    class IncomingMessage extends stream.Readable {
         ...
         * been aborted.
         * @since v10.1.0
         * @deprecated Since v17.0.0,v16.12.0 - Check `message.destroyed` from <a href="stream.html***REMOVED***class-streamreadable" class="type">stream.Readable</a>.
         */
        aborted: boolean;
        /**
