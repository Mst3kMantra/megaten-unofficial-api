...
// Project: https://github.com/jsdom/whatwg-url***REMOVED***readme
...
/** https://url.spec.whatwg.org/***REMOVED***url-representation */
...
/** https://url.spec.whatwg.org/***REMOVED***concept-ipv6 */
export type IPv6Address = [number, number, number, number, number, number, number, number];

/** https://url.spec.whatwg.org/***REMOVED***url-class */
export class URL {
...
/** https://url.spec.whatwg.org/***REMOVED***interface-urlsearchparams */
...
/** https://url.spec.whatwg.org/***REMOVED***concept-url-parser */
export function parseURL(
    input: string,
    options?: { readonly baseURL?: string | undefined; readonly encodingOverride?: string | undefined },
): URLRecord | null;

/** https://url.spec.whatwg.org/***REMOVED***concept-basic-url-parser */
...
/** https://url.spec.whatwg.org/***REMOVED***scheme-start-state */
...
/** https://url.spec.whatwg.org/***REMOVED***concept-url-serializer */
export function serializeURL(urlRecord: URLRecord, excludeFragment?: boolean): string;

/** https://url.spec.whatwg.org/***REMOVED***concept-host-serializer */
export function serializeHost(host: string | number | IPv6Address): string;

/** https://url.spec.whatwg.org/***REMOVED***serialize-an-integer */
export function serializeInteger(number: number): string;

/** https://html.spec.whatwg.org***REMOVED***ascii-serialisation-of-an-origin */
export function serializeURLOrigin(urlRecord: URLRecord): string;

/** https://url.spec.whatwg.org/***REMOVED***set-the-username */
export function setTheUsername(urlRecord: URLRecord, username: string): void;

/** https://url.spec.whatwg.org/***REMOVED***set-the-password */
export function setThePassword(urlRecord: URLRecord, password: string): void;

/** https://url.spec.whatwg.org/***REMOVED***cannot-have-a-username-password-port */
