***REMOVED*** socks examples

***REMOVED******REMOVED*** Example for SOCKS 'connect' command
...
***REMOVED******REMOVED******REMOVED*** Using createConnection with async/await
...
***REMOVED******REMOVED******REMOVED*** Using createConnection with Promises
...
***REMOVED******REMOVED******REMOVED*** Using createConnection with callbacks
...
***REMOVED******REMOVED******REMOVED*** Using event handlers
