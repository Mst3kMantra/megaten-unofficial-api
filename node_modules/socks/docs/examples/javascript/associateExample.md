...
***REMOVED******REMOVED*** Example for SOCKS 'associate' command
...
4. Client <--(udp frame) <-- Proxy <-- Destination (The destination client responds to the udp packet sent in ***REMOVED***3)
