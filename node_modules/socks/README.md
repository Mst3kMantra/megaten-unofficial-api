***REMOVED*** socks  [![Build Status](https://travis-ci.org/JoshGlazebrook/socks.svg?branch=master)](https://travis-ci.org/JoshGlazebrook/socks)  [![Coverage Status](https://coveralls.io/repos/github/JoshGlazebrook/socks/badge.svg?branch=master)](https://coveralls.io/github/JoshGlazebrook/socks?branch=v2)
...
***REMOVED******REMOVED******REMOVED*** Looking for v1?
...
***REMOVED******REMOVED*** Quick Start Example
...
***REMOVED******REMOVED*** Chaining Proxies
...
***REMOVED******REMOVED*** Bind Example (TCP Relay)
...
***REMOVED******REMOVED*** Associate Example (UDP Relay)
...
***REMOVED******REMOVED*** Additional Examples

[Documentation](docs/index.md)


***REMOVED******REMOVED*** Migrating from v1
...
* Class: SocksClient
  * [new SocksClient(options[, callback])](***REMOVED***new-socksclientoptions)
  * [Class Method: SocksClient.createConnection(options[, callback])](***REMOVED***class-method-socksclientcreateconnectionoptions-callback)
  * [Class Method: SocksClient.createConnectionChain(options[, callback])](***REMOVED***class-method-socksclientcreateconnectionchainoptions-callback)
  * [Class Method: SocksClient.createUDPFrame(options)](***REMOVED***class-method-socksclientcreateudpframedetails)
  * [Class Method: SocksClient.parseUDPFrame(data)](***REMOVED***class-method-socksclientparseudpframedata)
  * [Event: 'error'](***REMOVED***event-error)
  * [Event: 'bound'](***REMOVED***event-bound)
  * [Event: 'established'](***REMOVED***event-established)
  * [client.connect()](***REMOVED***clientconnect)
  * [client.socksClientOptions](***REMOVED***clientconnect)

***REMOVED******REMOVED******REMOVED*** SocksClient
...
***REMOVED******REMOVED******REMOVED*** new SocksClient(options)
...
***REMOVED******REMOVED******REMOVED*** SocksClientOptions
...
***REMOVED******REMOVED******REMOVED*** Class Method: SocksClient.createConnection(options[, callback])
* ```options``` { SocksClientOptions } - An object describing the SOCKS proxy to use, the command to send and establish, and the destination host to connect to.
...
***REMOVED******REMOVED******REMOVED*** Class Method: SocksClient.createConnectionChain(options[, callback])
...
***REMOVED******REMOVED******REMOVED*** Class Method: SocksClient.createUDPFrame(details)
...
***REMOVED******REMOVED******REMOVED*** Class Method: SocksClient.parseUDPFrame(data)
...
***REMOVED******REMOVED*** Event: 'established'
